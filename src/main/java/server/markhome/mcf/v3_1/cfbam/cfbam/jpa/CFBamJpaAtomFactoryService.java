...
// Description: Java 25 Factory service implementation for Atom JPA objects
...
/*
 *	Java 25 Factory service implementation for Atom JPA objects.
 */
public class CFBamJpaAtomFactoryService
    implements ICFBamAtomFactory
{
    ...
    public ICFBamAtomH newHRec() {
        ICFBamAtomH hrec = new CFBamJpaAtomH();
        return( hrec );
    }
