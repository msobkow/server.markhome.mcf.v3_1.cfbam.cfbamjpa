...
public class CFBamJpaBlobColService {
	...
	public CFBamJpaBlobCol create(CFBamJpaBlobCol data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31BlobColRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaBlobCol)(cfbam31BlobColRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaBlobCol update(CFBamJpaBlobCol data) {
		...
		CFBamJpaBlobCol existing = cfbam31BlobColRepository.findById((ICFLibKeyHash256)(data.getPKey()))
