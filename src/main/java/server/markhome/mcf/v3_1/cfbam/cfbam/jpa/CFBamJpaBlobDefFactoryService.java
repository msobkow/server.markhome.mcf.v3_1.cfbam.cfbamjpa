...
// Description: Java 25 Factory service implementation for BlobDef JPA objects
...
/*
 *	Java 25 Factory service implementation for BlobDef JPA objects.
 */
public class CFBamJpaBlobDefFactoryService
    implements ICFBamBlobDefFactory
{
    public CFBamJpaBlobDefFactoryService() { }

    @Override
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
    public ICFBamBlobDef newRec() {
        ICFBamBlobDef rec = new CFBamJpaBlobDef();
        return( rec );
    }
    ...
    public ICFBamBlobDefH newHRec() {
        ICFBamBlobDefH hrec = new CFBamJpaBlobDefH();
        return( hrec );
    }
