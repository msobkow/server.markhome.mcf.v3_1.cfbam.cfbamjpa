...
// Description: Java 25 Factory service implementation for BlobType JPA objects
...
/*
 *	Java 25 Factory service implementation for BlobType JPA objects.
 */
public class CFBamJpaBlobTypeFactoryService
    implements ICFBamBlobTypeFactory
{
    public CFBamJpaBlobTypeFactoryService() { }

    @Override
    public ICFBamBlobTypeBySchemaIdxKey newBySchemaIdxKey() {
		ICFBamBlobTypeBySchemaIdxKey key = new CFBamJpaBlobTypeBySchemaIdxKey();
	return( key );
    }
    ...
    public ICFBamBlobType newRec() {
        ICFBamBlobType rec = new CFBamJpaBlobType();
        return( rec );
    }
    ...
    public ICFBamBlobTypeH newHRec() {
        ICFBamBlobTypeH hrec = new CFBamJpaBlobTypeH();
        return( hrec );
    }
