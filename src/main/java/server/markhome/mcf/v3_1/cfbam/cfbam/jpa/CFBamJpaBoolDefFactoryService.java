...
// Description: Java 25 Factory service implementation for BoolDef JPA objects
...
/*
 *	Java 25 Factory service implementation for BoolDef JPA objects.
 */
public class CFBamJpaBoolDefFactoryService
    implements ICFBamBoolDefFactory
{
    ...
    public ICFBamBoolDefH newHRec() {
        ICFBamBoolDefH hrec = new CFBamJpaBoolDefH();
        return( hrec );
    }
