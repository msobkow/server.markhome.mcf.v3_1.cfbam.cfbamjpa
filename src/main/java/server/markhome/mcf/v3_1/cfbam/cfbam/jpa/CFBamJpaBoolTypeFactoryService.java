...
// Description: Java 25 Factory service implementation for BoolType JPA objects
...
/*
 *	Java 25 Factory service implementation for BoolType JPA objects.
 */
public class CFBamJpaBoolTypeFactoryService
    implements ICFBamBoolTypeFactory
{
    public CFBamJpaBoolTypeFactoryService() { }

    @Override
    public ICFBamBoolTypeBySchemaIdxKey newBySchemaIdxKey() {
		ICFBamBoolTypeBySchemaIdxKey key = new CFBamJpaBoolTypeBySchemaIdxKey();
	return( key );
    }
    ...
    public ICFBamBoolType newRec() {
        ICFBamBoolType rec = new CFBamJpaBoolType();
        return( rec );
    }
    ...
    public ICFBamBoolTypeH newHRec() {
        ICFBamBoolTypeH hrec = new CFBamJpaBoolTypeH();
        return( hrec );
    }
