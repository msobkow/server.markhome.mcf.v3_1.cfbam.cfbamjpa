		...
		Serializable
{
	...
	protected CFLibDbKeyHash256 createdByUserId = CFLibDbKeyHash256.fromHex(ICFBam$emitScopingMidfix$Chain.S_INIT_CREATED_BY);
	...
	protected CFLibDbKeyHash256 updatedByUserId = CFLibDbKeyHash256.fromHex(ICFBam$emitScopingMidfix$Chain.S_INIT_UPDATED_BY);
	...
	public void setRequiredLookupPrevRel(CFLibDbKeyHash256 argPrevRelationId) {
		...
		ICFBamRelation targetRec = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argPrevRelationId);
	...
	public void setRequiredLookupNextRel(CFLibDbKeyHash256 argNextRelationId) {
		...
		ICFBamRelation targetRec = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argNextRelationId);
