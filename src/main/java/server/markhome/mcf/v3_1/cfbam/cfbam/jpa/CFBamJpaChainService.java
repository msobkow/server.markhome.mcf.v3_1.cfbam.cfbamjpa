...
public class CFBamJpaChainService {
	...
	public CFBamJpaChain create(CFBamJpaChain data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31ChainRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaChain)(cfbam31ChainRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaChain update(CFBamJpaChain data) {
		...
		CFBamJpaChain existing = cfbam31ChainRepository.findById((ICFLibKeyHash256)(data.getPKey()))
