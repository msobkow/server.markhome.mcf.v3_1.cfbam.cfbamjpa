...
@Table(
	...
	indexes = {
		...
		@Index(name = "ClearDepRelationIdxRelation", columnList = "RelationIdRelation", unique = false),
		@Index(name = "ClearDepDefSchemaDefIdxDefSchema", columnList = "defschidDefSchema", unique = false)
	}
)
