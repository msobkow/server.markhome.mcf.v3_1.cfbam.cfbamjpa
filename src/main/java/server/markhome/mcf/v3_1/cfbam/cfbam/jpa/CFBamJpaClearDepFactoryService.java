...
// Description: Java 25 Factory service implementation for ClearDep JPA objects
...
/*
 *	Java 25 Factory service implementation for ClearDep JPA objects.
 */
public class CFBamJpaClearDepFactoryService
    implements ICFBamClearDepFactory
{
    ...
    public ICFBamClearDepH newHRec() {
        ICFBamClearDepH hrec = new CFBamJpaClearDepH();
        return( hrec );
    }
