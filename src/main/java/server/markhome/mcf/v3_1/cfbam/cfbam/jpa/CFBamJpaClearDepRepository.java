...
/**
 *	JpaRepository for the CFBamJpaClearDep entities defined in server.markhome.mcf.v3_1.cfbam.cfbam.jpa.
 *	The manufactured repositories try to provide a rich, do-it-all interface to the JPA data store, with both object and argument-based implementations of the interface defined.
 */
@Transactional(readOnly = true)
public interface CFBamJpaClearDepRepository extends JpaRepository<CFBamJpaClearDep, $implCommaIJavaOptAtomType$> {

	@Transactional
	@Modifying
	CFBamJpaClearDep save(CFBamJpaClearDep obj);
	...
	CFBamJpaClearDep get(@Param("id") ICFLibKeyHash256 requiredId);
	...
	List<CFBamJpaClearDep> findByTenantIdx(@Param("tenantId") ICFLibKeyHash256 requiredTenantId);
	...
	List<CFBamJpaClearDep> findByClearDepIdx(@Param("relationId") ICFLibKeyHash256 requiredRelationId);
	...
	List<CFBamJpaClearDep> findByDefSchemaIdx(@Param("defSchemaId") ICFLibKeyHash256 optionalDefSchemaId);
	...
	@Query("select r from CFBamJpaScope r where r.requiredId = :id")
	CFBamJpaClearDep lockByIdIdx(@Param("id") ICFLibKeyHash256 requiredId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaScope r where r.requiredTenantId = :tenantId")
	List<CFBamJpaClearDep> lockByTenantIdx(@Param("tenantId") ICFLibKeyHash256 requiredTenantId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaClearDep r where r.requiredLookupRelation.requiredId = :relationId")
	List<CFBamJpaClearDep> lockByClearDepIdx(@Param("relationId") ICFLibKeyHash256 requiredRelationId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaClearDep r where r.optionalLookupDefSchema.requiredId = :defSchemaId")
	List<CFBamJpaClearDep> lockByDefSchemaIdx(@Param("defSchemaId") ICFLibKeyHash256 optionalDefSchemaId);
