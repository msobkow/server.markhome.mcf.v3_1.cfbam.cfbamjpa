...
public class CFBamJpaClearDepService {
	...
	public CFBamJpaClearDep create(CFBamJpaClearDep data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31ClearDepRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaClearDep)(cfbam31ClearDepRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaClearDep update(CFBamJpaClearDep data) {
		...
		CFBamJpaClearDep existing = cfbam31ClearDepRepository.findById((ICFLibKeyHash256)(data.getPKey()))
