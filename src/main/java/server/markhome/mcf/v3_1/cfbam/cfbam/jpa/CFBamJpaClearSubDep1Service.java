...
public class CFBamJpaClearSubDep1Service {
	...
	public CFBamJpaClearSubDep1 create(CFBamJpaClearSubDep1 data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31ClearSubDep1Repository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaClearSubDep1)(cfbam31ClearSubDep1Repository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaClearSubDep1 update(CFBamJpaClearSubDep1 data) {
		...
		CFBamJpaClearSubDep1 existing = cfbam31ClearSubDep1Repository.findById((ICFLibKeyHash256)(data.getPKey()))
