...
// Description: Java 25 Factory service implementation for ClearSubDep2 JPA objects
...
/*
 *	Java 25 Factory service implementation for ClearSubDep2 JPA objects.
 */
public class CFBamJpaClearSubDep2FactoryService
    implements ICFBamClearSubDep2Factory
{
    ...
    public ICFBamClearSubDep2H newHRec() {
        ICFBamClearSubDep2H hrec = new CFBamJpaClearSubDep2H();
        return( hrec );
    }
