...
@Table(
	...
	indexes = {
		...
		@Index(name = "ClearSubDep3ClearSubDep2IdxClearSubDep2", columnList = "contclrdep2idClearSubDep2", unique = false)
	}
)
	...
	implements ICFBamClearSubDep3
{
	...
	@JoinColumn( name="contclrdep2idClearSubDep2", referencedColumnName="Id" )
	...
	public void setRequiredContainerClearSubDep2(ICFBamClearSubDep2 argObj) {
		if(argObj == null) {
			...
			if (requiredContainerClearSubDep2 != null) {
				requiredClearSubDep2Id = requiredContainerClearSubDep2.getRequiredId();
			}
			else {
			}
		}
	...
	public void setRequiredContainerClearSubDep2(CFLibDbKeyHash256 argClearSubDep2Id) {
		...
		ICFBamClearSubDep2 targetRec = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argClearSubDep2Id);
