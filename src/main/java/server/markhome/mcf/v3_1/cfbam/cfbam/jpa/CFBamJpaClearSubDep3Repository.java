...
public interface CFBamJpaClearSubDep3Repository extends JpaRepository<CFBamJpaClearSubDep3, $implCommaIJavaOptAtomType$> {

	@Transactional
	@Modifying
	CFBamJpaClearSubDep3 save(CFBamJpaClearSubDep3 obj);
	...
	CFBamJpaClearSubDep3 get(@Param("id") ICFLibKeyHash256 requiredId);
	...
	List<CFBamJpaClearSubDep3> findByTenantIdx(@Param("tenantId") ICFLibKeyHash256 requiredTenantId);
	...
	List<CFBamJpaClearSubDep3> findByClearDepIdx(@Param("relationId") ICFLibKeyHash256 requiredRelationId);
	...
	List<CFBamJpaClearSubDep3> findByDefSchemaIdx(@Param("defSchemaId") ICFLibKeyHash256 optionalDefSchemaId);
	...
	List<CFBamJpaClearSubDep3> findByClearSubDep2Idx(@Param("clearSubDep2Id") ICFLibKeyHash256 requiredClearSubDep2Id);
	...
	CFBamJpaClearSubDep3 findByUNameIdx(@Param("clearSubDep2Id") ICFLibKeyHash256 requiredClearSubDep2Id,
	...
	@Query("select r from CFBamJpaScope r where r.requiredId = :id")
	CFBamJpaClearSubDep3 lockByIdIdx(@Param("id") ICFLibKeyHash256 requiredId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaScope r where r.requiredTenantId = :tenantId")
	List<CFBamJpaClearSubDep3> lockByTenantIdx(@Param("tenantId") ICFLibKeyHash256 requiredTenantId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaClearDep r where r.requiredLookupRelation.requiredId = :relationId")
	List<CFBamJpaClearSubDep3> lockByClearDepIdx(@Param("relationId") ICFLibKeyHash256 requiredRelationId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaClearDep r where r.optionalLookupDefSchema.requiredId = :defSchemaId")
	List<CFBamJpaClearSubDep3> lockByDefSchemaIdx(@Param("defSchemaId") ICFLibKeyHash256 optionalDefSchemaId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaClearSubDep3 r where r.requiredContainerClearSubDep2.requiredId = :clearSubDep2Id")
	List<CFBamJpaClearSubDep3> lockByClearSubDep2Idx(@Param("clearSubDep2Id") ICFLibKeyHash256 requiredClearSubDep2Id);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaClearSubDep3 r where r.requiredContainerClearSubDep2.requiredId = :clearSubDep2Id and r.requiredName = :name")
	CFBamJpaClearSubDep3 lockByUNameIdx(@Param("clearSubDep2Id") ICFLibKeyHash256 requiredClearSubDep2Id,
		@Param("name") String requiredName);
	...
	void deleteByClearSubDep2Idx(@Param("clearSubDep2Id") ICFLibKeyHash256 requiredClearSubDep2Id);
	...
	void deleteByUNameIdx(@Param("clearSubDep2Id") ICFLibKeyHash256 requiredClearSubDep2Id,
		@Param("name") String requiredName);
