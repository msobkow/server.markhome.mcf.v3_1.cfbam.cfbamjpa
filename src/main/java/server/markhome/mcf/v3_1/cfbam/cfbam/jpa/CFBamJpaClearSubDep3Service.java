...
public class CFBamJpaClearSubDep3Service {
	...
	public CFBamJpaClearSubDep3 create(CFBamJpaClearSubDep3 data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31ClearSubDep3Repository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaClearSubDep3)(cfbam31ClearSubDep3Repository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaClearSubDep3 update(CFBamJpaClearSubDep3 data) {
		...
		CFBamJpaClearSubDep3 existing = cfbam31ClearSubDep3Repository.findById((ICFLibKeyHash256)(data.getPKey()))
