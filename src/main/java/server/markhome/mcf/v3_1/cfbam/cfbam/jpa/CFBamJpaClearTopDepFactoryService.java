...
// Description: Java 25 Factory service implementation for ClearTopDep JPA objects
...
/*
 *	Java 25 Factory service implementation for ClearTopDep JPA objects.
 */
public class CFBamJpaClearTopDepFactoryService
    implements ICFBamClearTopDepFactory
{
    ...
    public ICFBamClearTopDepH newHRec() {
        ICFBamClearTopDepH hrec = new CFBamJpaClearTopDepH();
        return( hrec );
    }
