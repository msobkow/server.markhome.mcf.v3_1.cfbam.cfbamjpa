...
public class CFBamJpaClearTopDepService {
	...
	public CFBamJpaClearTopDep create(CFBamJpaClearTopDep data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31ClearTopDepRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaClearTopDep)(cfbam31ClearTopDepRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaClearTopDep update(CFBamJpaClearTopDep data) {
		...
		CFBamJpaClearTopDep existing = cfbam31ClearTopDepRepository.findById((ICFLibKeyHash256)(data.getPKey()))
