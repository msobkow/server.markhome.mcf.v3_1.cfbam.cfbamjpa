...
// Description: Java 25 Factory service implementation for DateCol JPA objects
...
/*
 *	Java 25 Factory service implementation for DateCol JPA objects.
 */
public class CFBamJpaDateColFactoryService
    implements ICFBamDateColFactory
{
    public CFBamJpaDateColFactoryService() { }

    @Override
    public ICFBamDateColByTableIdxKey newByTableIdxKey() {
		ICFBamDateColByTableIdxKey key = new CFBamJpaDateColByTableIdxKey();
	return( key );
    }
    ...
    public ICFBamDateCol newRec() {
        ICFBamDateCol rec = new CFBamJpaDateCol();
        return( rec );
    }
    ...
    public ICFBamDateColH newHRec() {
        ICFBamDateColH hrec = new CFBamJpaDateColH();
        return( hrec );
    }
