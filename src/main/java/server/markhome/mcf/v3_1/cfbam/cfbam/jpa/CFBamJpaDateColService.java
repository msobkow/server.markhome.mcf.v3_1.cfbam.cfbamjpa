...
public class CFBamJpaDateColService {
	...
	public CFBamJpaDateCol create(CFBamJpaDateCol data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31DateColRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaDateCol)(cfbam31DateColRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaDateCol update(CFBamJpaDateCol data) {
		...
		CFBamJpaDateCol existing = cfbam31DateColRepository.findById((ICFLibKeyHash256)(data.getPKey()))
