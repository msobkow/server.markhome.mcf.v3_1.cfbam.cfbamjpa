...
// Description: Java 25 Factory service implementation for DateDef JPA objects
...
/*
 *	Java 25 Factory service implementation for DateDef JPA objects.
 */
public class CFBamJpaDateDefFactoryService
    implements ICFBamDateDefFactory
{
    public CFBamJpaDateDefFactoryService() { }

    @Override
    public ICFBamDateDef newRec() {
        ICFBamDateDef rec = new CFBamJpaDateDef();
        return( rec );
    }
    ...
    public ICFBamDateDefH newHRec() {
        ICFBamDateDefH hrec = new CFBamJpaDateDefH();
        return( hrec );
    }
