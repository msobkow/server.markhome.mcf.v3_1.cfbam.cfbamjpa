...
public class CFBamJpaDateDefService {
	...
	public CFBamJpaDateDef create(CFBamJpaDateDef data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31DateDefRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaDateDef)(cfbam31DateDefRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaDateDef update(CFBamJpaDateDef data) {
		...
		CFBamJpaDateDef existing = cfbam31DateDefRepository.findById((ICFLibKeyHash256)(data.getPKey()))
