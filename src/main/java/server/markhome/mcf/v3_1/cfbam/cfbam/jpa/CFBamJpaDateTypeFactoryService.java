...
// Description: Java 25 Factory service implementation for DateType JPA objects
...
/*
 *	Java 25 Factory service implementation for DateType JPA objects.
 */
public class CFBamJpaDateTypeFactoryService
    implements ICFBamDateTypeFactory
{
    public CFBamJpaDateTypeFactoryService() { }

    @Override
    public ICFBamDateTypeBySchemaIdxKey newBySchemaIdxKey() {
		ICFBamDateTypeBySchemaIdxKey key = new CFBamJpaDateTypeBySchemaIdxKey();
	return( key );
    }
    ...
    public ICFBamDateType newRec() {
        ICFBamDateType rec = new CFBamJpaDateType();
        return( rec );
    }
    ...
    public ICFBamDateTypeH newHRec() {
        ICFBamDateTypeH hrec = new CFBamJpaDateTypeH();
        return( hrec );
    }
