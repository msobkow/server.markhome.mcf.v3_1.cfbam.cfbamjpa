...
public class CFBamJpaDateTypeService {
	...
	public CFBamJpaDateType create(CFBamJpaDateType data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31DateTypeRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaDateType)(cfbam31DateTypeRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaDateType update(CFBamJpaDateType data) {
		...
		CFBamJpaDateType existing = cfbam31DateTypeRepository.findById((ICFLibKeyHash256)(data.getPKey()))
