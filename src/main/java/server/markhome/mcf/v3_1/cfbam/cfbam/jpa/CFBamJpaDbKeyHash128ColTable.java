...
public class CFBamJpaDbKeyHash128ColTable implements ICFBamDbKeyHash128ColTable
{
		...
		ICFBamDbKeyHash128Col rec )
	{
		...
		if (!permissionGranted) {
			throw new CFLibPermissionDeniedException(getClass(), S_ProcName, "createdbkeyhash128col", ICFBamSchema.SCHEMA_NAME, ICFBamDbKeyHash128ColTable.TABLE_NAME, Authorization.getAuthUuid6().toString());//"Permission '%4$s' denied attempting to access %1$s.%2$s for user id %3$s"
		}
		...
		ICFBamDbKeyHash128Col rec )
	{
		...
		if (!permissionGranted) {
			throw new CFLibPermissionDeniedException(getClass(), S_ProcName, "updatedbkeyhash128col", ICFBamSchema.SCHEMA_NAME, ICFBamDbKeyHash128ColTable.TABLE_NAME, Authorization.getAuthUuid6().toString());//"Permission '%4$s' denied attempting to access %1$s.%2$s for user id %3$s"
		}
		...
		ICFBamDbKeyHash128Col rec )
	{
		...
		if (!permissionGranted) {
			throw new CFLibPermissionDeniedException(getClass(), S_ProcName, "deletedbkeyhash128col", ICFBamSchema.SCHEMA_NAME, ICFBamDbKeyHash128ColTable.TABLE_NAME, Authorization.getAuthUuid6().toString());//"Permission '%4$s' denied attempting to access %1$s.%2$s for user id %3$s"
		}
		...
		CFLibDbKeyHash256 PKey )
	{
		...
		if (!permissionGranted) {
			throw new CFLibPermissionDeniedException(getClass(), S_ProcName, "readdbkeyhash128col", ICFBamSchema.SCHEMA_NAME, ICFBamDbKeyHash128ColTable.TABLE_NAME, Authorization.getAuthUuid6().toString());//"Permission '%4$s' denied attempting to access %1$s.%2$s for user id %3$s"
		}
