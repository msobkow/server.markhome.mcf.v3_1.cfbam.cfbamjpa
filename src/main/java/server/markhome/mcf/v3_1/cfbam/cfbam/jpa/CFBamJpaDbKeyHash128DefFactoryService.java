...
// Description: Java 25 Factory service implementation for DbKeyHash128Def JPA objects
...
/*
 *	Java 25 Factory service implementation for DbKeyHash128Def JPA objects.
 */
public class CFBamJpaDbKeyHash128DefFactoryService
    implements ICFBamDbKeyHash128DefFactory
{
    public CFBamJpaDbKeyHash128DefFactoryService() { }

    @Override
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
    public ICFBamDbKeyHash128Def newRec() {
        ICFBamDbKeyHash128Def rec = new CFBamJpaDbKeyHash128Def();
        return( rec );
    }
    ...
    public ICFBamDbKeyHash128DefH newHRec() {
        ICFBamDbKeyHash128DefH hrec = new CFBamJpaDbKeyHash128DefH();
        return( hrec );
    }
