...
// Description: Java 25 Factory service implementation for DbKeyHash128Type JPA objects
...
/*
 *	Java 25 Factory service implementation for DbKeyHash128Type JPA objects.
 */
public class CFBamJpaDbKeyHash128TypeFactoryService
    implements ICFBamDbKeyHash128TypeFactory
{
    public CFBamJpaDbKeyHash128TypeFactoryService() { }

    @Override
    public ICFBamDbKeyHash128TypeBySchemaIdxKey newBySchemaIdxKey() {
		ICFBamDbKeyHash128TypeBySchemaIdxKey key = new CFBamJpaDbKeyHash128TypeBySchemaIdxKey();
	return( key );
    }
    ...
    public ICFBamDbKeyHash128Type newRec() {
        ICFBamDbKeyHash128Type rec = new CFBamJpaDbKeyHash128Type();
        return( rec );
    }
    ...
    public ICFBamDbKeyHash128TypeH newHRec() {
        ICFBamDbKeyHash128TypeH hrec = new CFBamJpaDbKeyHash128TypeH();
        return( hrec );
    }
