...
// Description: Java 25 Factory service implementation for DbKeyHash160Col JPA objects
...
/*
 *	Java 25 Factory service implementation for DbKeyHash160Col JPA objects.
 */
public class CFBamJpaDbKeyHash160ColFactoryService
    implements ICFBamDbKeyHash160ColFactory
{
    public CFBamJpaDbKeyHash160ColFactoryService() { }

    @Override
    public ICFBamDbKeyHash160ColByTableIdxKey newByTableIdxKey() {
		ICFBamDbKeyHash160ColByTableIdxKey key = new CFBamJpaDbKeyHash160ColByTableIdxKey();
	return( key );
    }
    ...
    public ICFBamDbKeyHash160Col newRec() {
        ICFBamDbKeyHash160Col rec = new CFBamJpaDbKeyHash160Col();
        return( rec );
    }
    ...
    public ICFBamDbKeyHash160ColH newHRec() {
        ICFBamDbKeyHash160ColH hrec = new CFBamJpaDbKeyHash160ColH();
        return( hrec );
    }
