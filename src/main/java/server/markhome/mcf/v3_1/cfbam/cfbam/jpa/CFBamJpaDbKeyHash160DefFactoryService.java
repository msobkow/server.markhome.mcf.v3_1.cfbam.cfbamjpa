...
// Description: Java 25 Factory service implementation for DbKeyHash160Def JPA objects
...
/*
 *	Java 25 Factory service implementation for DbKeyHash160Def JPA objects.
 */
public class CFBamJpaDbKeyHash160DefFactoryService
    implements ICFBamDbKeyHash160DefFactory
{
    public CFBamJpaDbKeyHash160DefFactoryService() { }

    @Override
    public ICFBamDbKeyHash160Def newRec() {
        ICFBamDbKeyHash160Def rec = new CFBamJpaDbKeyHash160Def();
        return( rec );
    }
    ...
    public ICFBamDbKeyHash160DefH newHRec() {
        ICFBamDbKeyHash160DefH hrec = new CFBamJpaDbKeyHash160DefH();
        return( hrec );
    }
