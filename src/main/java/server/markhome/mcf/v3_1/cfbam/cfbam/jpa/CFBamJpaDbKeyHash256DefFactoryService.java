...
// Description: Java 25 Factory service implementation for DbKeyHash256Def JPA objects
...
/*
 *	Java 25 Factory service implementation for DbKeyHash256Def JPA objects.
 */
public class CFBamJpaDbKeyHash256DefFactoryService
    implements ICFBamDbKeyHash256DefFactory
{
    ...
    public ICFBamDbKeyHash256DefH newHRec() {
        ICFBamDbKeyHash256DefH hrec = new CFBamJpaDbKeyHash256DefH();
        return( hrec );
    }
