...
// Description: Java 25 Factory service implementation for DbKeyHash256Gen JPA objects
...
/*
 *	Java 25 Factory service implementation for DbKeyHash256Gen JPA objects.
 */
public class CFBamJpaDbKeyHash256GenFactoryService
    implements ICFBamDbKeyHash256GenFactory
{
    public CFBamJpaDbKeyHash256GenFactoryService() { }

    @Override
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
    public ICFBamDbKeyHash256Gen newRec() {
        ICFBamDbKeyHash256Gen rec = new CFBamJpaDbKeyHash256Gen();
        return( rec );
    }
    ...
    public ICFBamDbKeyHash256GenH newHRec() {
        ICFBamDbKeyHash256GenH hrec = new CFBamJpaDbKeyHash256GenH();
        return( hrec );
    }
