...
// Description: Java 25 Factory service implementation for DbKeyHash256Type JPA objects
...
/*
 *	Java 25 Factory service implementation for DbKeyHash256Type JPA objects.
 */
public class CFBamJpaDbKeyHash256TypeFactoryService
    implements ICFBamDbKeyHash256TypeFactory
{
    public CFBamJpaDbKeyHash256TypeFactoryService() { }

    @Override
    public ICFBamDbKeyHash256TypeBySchemaIdxKey newBySchemaIdxKey() {
		ICFBamDbKeyHash256TypeBySchemaIdxKey key = new CFBamJpaDbKeyHash256TypeBySchemaIdxKey();
	return( key );
    }
    ...
    public ICFBamDbKeyHash256Type newRec() {
        ICFBamDbKeyHash256Type rec = new CFBamJpaDbKeyHash256Type();
        return( rec );
    }
    ...
    public ICFBamDbKeyHash256TypeH newHRec() {
        ICFBamDbKeyHash256TypeH hrec = new CFBamJpaDbKeyHash256TypeH();
        return( hrec );
    }
