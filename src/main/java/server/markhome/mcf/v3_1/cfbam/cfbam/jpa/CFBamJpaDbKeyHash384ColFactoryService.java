...
// Description: Java 25 Factory service implementation for DbKeyHash384Col JPA objects
...
/*
 *	Java 25 Factory service implementation for DbKeyHash384Col JPA objects.
 */
public class CFBamJpaDbKeyHash384ColFactoryService
    implements ICFBamDbKeyHash384ColFactory
{
    public CFBamJpaDbKeyHash384ColFactoryService() { }

    @Override
    public ICFBamDbKeyHash384ColByTableIdxKey newByTableIdxKey() {
		ICFBamDbKeyHash384ColByTableIdxKey key = new CFBamJpaDbKeyHash384ColByTableIdxKey();
	return( key );
    }
    ...
    public ICFBamDbKeyHash384Col newRec() {
        ICFBamDbKeyHash384Col rec = new CFBamJpaDbKeyHash384Col();
        return( rec );
    }
    ...
    public ICFBamDbKeyHash384ColH newHRec() {
        ICFBamDbKeyHash384ColH hrec = new CFBamJpaDbKeyHash384ColH();
        return( hrec );
    }
