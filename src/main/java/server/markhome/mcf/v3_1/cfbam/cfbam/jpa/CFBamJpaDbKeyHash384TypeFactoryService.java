...
// Description: Java 25 Factory service implementation for DbKeyHash384Type JPA objects
...
/*
 *	Java 25 Factory service implementation for DbKeyHash384Type JPA objects.
 */
public class CFBamJpaDbKeyHash384TypeFactoryService
    implements ICFBamDbKeyHash384TypeFactory
{
    public CFBamJpaDbKeyHash384TypeFactoryService() { }

    @Override
    public ICFBamDbKeyHash384TypeBySchemaIdxKey newBySchemaIdxKey() {
		ICFBamDbKeyHash384TypeBySchemaIdxKey key = new CFBamJpaDbKeyHash384TypeBySchemaIdxKey();
	return( key );
    }
    ...
    public ICFBamDbKeyHash384Type newRec() {
        ICFBamDbKeyHash384Type rec = new CFBamJpaDbKeyHash384Type();
        return( rec );
    }
    ...
    public ICFBamDbKeyHash384TypeH newHRec() {
        ICFBamDbKeyHash384TypeH hrec = new CFBamJpaDbKeyHash384TypeH();
        return( hrec );
    }
