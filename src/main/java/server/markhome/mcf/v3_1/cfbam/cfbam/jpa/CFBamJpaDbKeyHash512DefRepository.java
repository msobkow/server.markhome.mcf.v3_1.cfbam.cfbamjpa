...
/**
 *	JpaRepository for the CFBamJpaDbKeyHash512Def entities defined in server.markhome.mcf.v3_1.cfbam.cfbam.jpa.
 *	The manufactured repositories try to provide a rich, do-it-all interface to the JPA data store, with both object and argument-based implementations of the interface defined.
 */
@Transactional(readOnly = true)
public interface CFBamJpaDbKeyHash512DefRepository extends JpaRepository<CFBamJpaDbKeyHash512Def, $implCommaIJavaOptAtomType$> {

	@Transactional
	@Modifying
	CFBamJpaDbKeyHash512Def save(CFBamJpaDbKeyHash512Def obj);
	...
	CFBamJpaDbKeyHash512Def get(@Param("id") ICFLibKeyHash256 requiredId);
	...
	CFBamJpaDbKeyHash512Def findByUNameIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
	...
	List<CFBamJpaDbKeyHash512Def> findByScopeIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId);
	...
	List<CFBamJpaDbKeyHash512Def> findByDefSchemaIdx(@Param("defSchemaId") ICFLibKeyHash256 optionalDefSchemaId);
	...
	List<CFBamJpaDbKeyHash512Def> findByPrevIdx(@Param("prevId") ICFLibKeyHash256 optionalPrevId);
	...
	List<CFBamJpaDbKeyHash512Def> findByNextIdx(@Param("nextId") ICFLibKeyHash256 optionalNextId);
	...
	List<CFBamJpaDbKeyHash512Def> findByContPrevIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
	...
	List<CFBamJpaDbKeyHash512Def> findByContNextIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
	...
	@Query("select r from CFBamJpaValue r where r.requiredId = :id")
	CFBamJpaDbKeyHash512Def lockByIdIdx(@Param("id") ICFLibKeyHash256 requiredId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredContainerScope.requiredId = :scopeId and r.requiredName = :name")
	CFBamJpaDbKeyHash512Def lockByUNameIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
		@Param("name") String requiredName);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredContainerScope.requiredId = :scopeId")
	List<CFBamJpaDbKeyHash512Def> lockByScopeIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.optionalLookupDefSchema.requiredId = :defSchemaId")
	List<CFBamJpaDbKeyHash512Def> lockByDefSchemaIdx(@Param("defSchemaId") ICFLibKeyHash256 optionalDefSchemaId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.optionalLookupPrev.requiredId = :prevId")
	List<CFBamJpaDbKeyHash512Def> lockByPrevIdx(@Param("prevId") ICFLibKeyHash256 optionalPrevId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.optionalLookupNext.requiredId = :nextId")
	List<CFBamJpaDbKeyHash512Def> lockByNextIdx(@Param("nextId") ICFLibKeyHash256 optionalNextId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredContainerScope.requiredId = :scopeId and r.optionalLookupPrev.requiredId = :prevId")
	List<CFBamJpaDbKeyHash512Def> lockByContPrevIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
		@Param("prevId") ICFLibKeyHash256 optionalPrevId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredContainerScope.requiredId = :scopeId and r.optionalLookupNext.requiredId = :nextId")
	List<CFBamJpaDbKeyHash512Def> lockByContNextIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
		@Param("nextId") ICFLibKeyHash256 optionalNextId);
