...
// Description: Java 25 Factory service implementation for DbKeyHash512Gen JPA objects
...
/*
 *	Java 25 Factory service implementation for DbKeyHash512Gen JPA objects.
 */
public class CFBamJpaDbKeyHash512GenFactoryService
    implements ICFBamDbKeyHash512GenFactory
{
    public CFBamJpaDbKeyHash512GenFactoryService() { }

    @Override
    public ICFBamDbKeyHash512Gen newRec() {
        ICFBamDbKeyHash512Gen rec = new CFBamJpaDbKeyHash512Gen();
        return( rec );
    }
    ...
    public ICFBamDbKeyHash512GenH newHRec() {
        ICFBamDbKeyHash512GenH hrec = new CFBamJpaDbKeyHash512GenH();
        return( hrec );
    }
