...
public class CFBamJpaDelDepService {
	...
	public CFBamJpaDelDep create(CFBamJpaDelDep data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31DelDepRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaDelDep)(cfbam31DelDepRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaDelDep update(CFBamJpaDelDep data) {
		...
		CFBamJpaDelDep existing = cfbam31DelDepRepository.findById((ICFLibKeyHash256)(data.getPKey()))
