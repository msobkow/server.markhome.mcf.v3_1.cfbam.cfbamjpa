...
public class CFBamJpaDelSubDep1Service {
	...
	public CFBamJpaDelSubDep1 create(CFBamJpaDelSubDep1 data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31DelSubDep1Repository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaDelSubDep1)(cfbam31DelSubDep1Repository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaDelSubDep1 update(CFBamJpaDelSubDep1 data) {
		...
		CFBamJpaDelSubDep1 existing = cfbam31DelSubDep1Repository.findById((ICFLibKeyHash256)(data.getPKey()))
