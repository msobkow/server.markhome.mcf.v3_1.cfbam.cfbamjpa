...
@Table(
	...
	indexes = {
		...
		@Index(name = "DelSubDep2DelSubDep1IdxDelSubDep1", columnList = "contdeldep1idDelSubDep1", unique = false)
	}
)
	...
	implements ICFBamDelSubDep2
{
	...
	public List<ICFBamDelSubDep3> getOptionalComponentsDelDep() {
		List<ICFBamDelSubDep3> retlist = (optionalComponentsDelDep != null) ? new ArrayList<>(optionalComponentsDelDep) : new ArrayList<>();
		return( retlist );
	}
