...
public class CFBamJpaDelSubDep2Service {
	...
	public CFBamJpaDelSubDep2 create(CFBamJpaDelSubDep2 data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31DelSubDep2Repository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaDelSubDep2)(cfbam31DelSubDep2Repository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaDelSubDep2 update(CFBamJpaDelSubDep2 data) {
		...
		CFBamJpaDelSubDep2 existing = cfbam31DelSubDep2Repository.findById((ICFLibKeyHash256)(data.getPKey()))
