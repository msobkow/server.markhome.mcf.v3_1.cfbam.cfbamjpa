...
public class CFBamJpaDelSubDep3Service {
	...
	public CFBamJpaDelSubDep3 create(CFBamJpaDelSubDep3 data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31DelSubDep3Repository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaDelSubDep3)(cfbam31DelSubDep3Repository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaDelSubDep3 update(CFBamJpaDelSubDep3 data) {
		...
		CFBamJpaDelSubDep3 existing = cfbam31DelSubDep3Repository.findById((ICFLibKeyHash256)(data.getPKey()))
