...
public class CFBamJpaDelTopDepService {
	...
	public CFBamJpaDelTopDep create(CFBamJpaDelTopDep data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31DelTopDepRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaDelTopDep)(cfbam31DelTopDepRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaDelTopDep update(CFBamJpaDelTopDep data) {
		...
		CFBamJpaDelTopDep existing = cfbam31DelTopDepRepository.findById((ICFLibKeyHash256)(data.getPKey()))
