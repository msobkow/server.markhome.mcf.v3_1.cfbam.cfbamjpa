...
// Description: Java 25 Factory service implementation for DoubleDef JPA objects
...
/*
 *	Java 25 Factory service implementation for DoubleDef JPA objects.
 */
public class CFBamJpaDoubleDefFactoryService
    implements ICFBamDoubleDefFactory
{
    public CFBamJpaDoubleDefFactoryService() { }

    @Override
    public ICFBamDoubleDef newRec() {
        ICFBamDoubleDef rec = new CFBamJpaDoubleDef();
        return( rec );
    }
    ...
    public ICFBamDoubleDefH newHRec() {
        ICFBamDoubleDefH hrec = new CFBamJpaDoubleDefH();
        return( hrec );
    }
