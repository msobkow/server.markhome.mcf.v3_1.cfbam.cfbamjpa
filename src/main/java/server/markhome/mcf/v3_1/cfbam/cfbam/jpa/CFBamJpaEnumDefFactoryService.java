...
// Description: Java 25 Factory service implementation for EnumDef JPA objects
...
/*
 *	Java 25 Factory service implementation for EnumDef JPA objects.
 */
public class CFBamJpaEnumDefFactoryService
    implements ICFBamEnumDefFactory
{
    ...
    public ICFBamEnumDefH newHRec() {
        ICFBamEnumDefH hrec = new CFBamJpaEnumDefH();
        return( hrec );
    }
