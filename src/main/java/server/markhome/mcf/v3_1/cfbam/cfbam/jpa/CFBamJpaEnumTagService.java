...
public class CFBamJpaEnumTagService {
	...
	public CFBamJpaEnumTag create(CFBamJpaEnumTag data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31EnumTagRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaEnumTag)(cfbam31EnumTagRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaEnumTag update(CFBamJpaEnumTag data) {
		...
		CFBamJpaEnumTag existing = cfbam31EnumTagRepository.findById((ICFLibKeyHash256)(data.getPKey()))
