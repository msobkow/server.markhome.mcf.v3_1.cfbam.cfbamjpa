...
public class CFBamJpaFloatColService {
	...
	public CFBamJpaFloatCol create(CFBamJpaFloatCol data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31FloatColRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaFloatCol)(cfbam31FloatColRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaFloatCol update(CFBamJpaFloatCol data) {
		...
		CFBamJpaFloatCol existing = cfbam31FloatColRepository.findById((ICFLibKeyHash256)(data.getPKey()))
