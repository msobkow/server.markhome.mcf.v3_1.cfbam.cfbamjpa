...
// Description: Java 25 Factory service implementation for FloatDef JPA objects
...
/*
 *	Java 25 Factory service implementation for FloatDef JPA objects.
 */
public class CFBamJpaFloatDefFactoryService
    implements ICFBamFloatDefFactory
{
    ...
    public ICFBamFloatDefH newHRec() {
        ICFBamFloatDefH hrec = new CFBamJpaFloatDefH();
        return( hrec );
    }
