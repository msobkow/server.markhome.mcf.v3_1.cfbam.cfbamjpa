...
// Description: Java 25 Factory service implementation for FloatType JPA objects
...
/*
 *	Java 25 Factory service implementation for FloatType JPA objects.
 */
public class CFBamJpaFloatTypeFactoryService
    implements ICFBamFloatTypeFactory
{
    public CFBamJpaFloatTypeFactoryService() { }

    @Override
    public ICFBamFloatTypeBySchemaIdxKey newBySchemaIdxKey() {
		ICFBamFloatTypeBySchemaIdxKey key = new CFBamJpaFloatTypeBySchemaIdxKey();
	return( key );
    }
    ...
    public ICFBamFloatType newRec() {
        ICFBamFloatType rec = new CFBamJpaFloatType();
        return( rec );
    }
    ...
    public ICFBamFloatTypeH newHRec() {
        ICFBamFloatTypeH hrec = new CFBamJpaFloatTypeH();
        return( hrec );
    }
