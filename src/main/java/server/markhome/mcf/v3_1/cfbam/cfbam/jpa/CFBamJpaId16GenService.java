...
public class CFBamJpaId16GenService {
	...
	public CFBamJpaId16Gen create(CFBamJpaId16Gen data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31Id16GenRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaId16Gen)(cfbam31Id16GenRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaId16Gen update(CFBamJpaId16Gen data) {
		...
		CFBamJpaId16Gen existing = cfbam31Id16GenRepository.findById((ICFLibKeyHash256)(data.getPKey()))
