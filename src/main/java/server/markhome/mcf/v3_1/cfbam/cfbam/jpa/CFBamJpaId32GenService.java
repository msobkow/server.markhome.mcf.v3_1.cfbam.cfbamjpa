...
public class CFBamJpaId32GenService {
	...
	public CFBamJpaId32Gen create(CFBamJpaId32Gen data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31Id32GenRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaId32Gen)(cfbam31Id32GenRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaId32Gen update(CFBamJpaId32Gen data) {
		...
		CFBamJpaId32Gen existing = cfbam31Id32GenRepository.findById((ICFLibKeyHash256)(data.getPKey()))
