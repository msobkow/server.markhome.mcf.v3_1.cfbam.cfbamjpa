...
// Description: Java 25 Factory service implementation for Id64Gen JPA objects
...
/*
 *	Java 25 Factory service implementation for Id64Gen JPA objects.
 */
public class CFBamJpaId64GenFactoryService
    implements ICFBamId64GenFactory
{
    ...
    public ICFBamId64GenH newHRec() {
        ICFBamId64GenH hrec = new CFBamJpaId64GenH();
        return( hrec );
    }
