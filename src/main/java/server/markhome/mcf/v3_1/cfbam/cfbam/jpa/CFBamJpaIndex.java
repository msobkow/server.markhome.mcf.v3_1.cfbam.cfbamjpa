...
@Table(
	...
	indexes = {
		...
		@Index(name = "IndexCodeVisIdx", columnList = "codevis", unique = false),
		@Index(name = "IndexTableCodeVisIdx", columnList = "TableId, codevis", unique = false),
		@Index(name = "IndexDefSchemaDefIdx", columnList = "defschid", unique = false),
		@Index(name = "IndexTableIdxTable", columnList = "TableIdTable", unique = false),
		@Index(name = "IndexDefSchemaDefIdxDefSchema", columnList = "defschidDefSchema", unique = false)
	}
)
	...
	implements ICFBamIndex
{
	...
	@OneToMany(fetch=FetchType.LAZY, mappedBy="requiredContainerIndexDef")
	protected Set<CFBamJpaIndexTweak> optionalComponentsTweaks;
	...
	public List<ICFBamIndexCol> getOptionalComponentsColumns() {
		List<ICFBamIndexCol> retlist = (optionalComponentsColumns != null) ? new ArrayList<>(optionalComponentsColumns) : new ArrayList<>();
		return( retlist );
	}

	@Override
	public List<ICFBamIndexTweak> getOptionalComponentsTweaks() {
		List<ICFBamIndexTweak> retlist = (optionalComponentsTweaks != null) ? new ArrayList<>(optionalComponentsTweaks) : new ArrayList<>();
		return( retlist );
	}
