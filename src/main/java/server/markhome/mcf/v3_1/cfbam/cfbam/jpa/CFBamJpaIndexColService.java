...
public class CFBamJpaIndexColService {
	...
	public CFBamJpaIndexCol create(CFBamJpaIndexCol data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31IndexColRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaIndexCol)(cfbam31IndexColRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaIndexCol update(CFBamJpaIndexCol data) {
		...
		CFBamJpaIndexCol existing = cfbam31IndexColRepository.findById((ICFLibKeyHash256)(data.getPKey()))
