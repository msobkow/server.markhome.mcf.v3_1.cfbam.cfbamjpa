...
public class CFBamJpaIndexService {
	...
	public CFBamJpaIndex create(CFBamJpaIndex data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31IndexRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaIndex)(cfbam31IndexRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaIndex update(CFBamJpaIndex data) {
		...
		CFBamJpaIndex existing = cfbam31IndexRepository.findById((ICFLibKeyHash256)(data.getPKey()))
