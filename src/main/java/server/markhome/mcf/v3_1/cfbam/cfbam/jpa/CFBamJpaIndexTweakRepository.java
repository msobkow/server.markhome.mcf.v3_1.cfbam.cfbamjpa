...
public interface CFBamJpaIndexTweakRepository extends JpaRepository<CFBamJpaIndexTweak, CFLibDbKeyHash256> {
	...
	CFBamJpaIndexTweak get(@Param("id") CFLibDbKeyHash256 requiredId);
	...
	CFBamJpaIndexTweak findByUNameIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
	...
	List<CFBamJpaIndexTweak> findByValTentIdx(@Param("tenantId") CFLibDbKeyHash256 requiredTenantId);
	...
	List<CFBamJpaIndexTweak> findByScopeIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId);
	...
	List<CFBamJpaIndexTweak> findByDefSchemaIdx(@Param("defSchemaId") CFLibDbKeyHash256 optionalDefSchemaId);
	...
	CFBamJpaIndexTweak findByUDefIdx(@Param("tenantId") CFLibDbKeyHash256 requiredTenantId,
	...
	List<CFBamJpaIndexTweak> findByIndexIdx(@Param("indexId") CFLibDbKeyHash256 requiredIndexId);
	...
	@Query("select r from CFBamJpaTweak r where r.requiredId = :id")
	CFBamJpaIndexTweak lockByIdIdx(@Param("id") CFLibDbKeyHash256 requiredId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaTweak r where r.requiredContainerScopeDef.requiredId = :scopeId and r.requiredName = :name")
	CFBamJpaIndexTweak lockByUNameIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("name") String requiredName);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaTweak r where r.requiredTenantId = :tenantId")
	List<CFBamJpaIndexTweak> lockByValTentIdx(@Param("tenantId") CFLibDbKeyHash256 requiredTenantId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaTweak r where r.requiredContainerScopeDef.requiredId = :scopeId")
	List<CFBamJpaIndexTweak> lockByScopeIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaTweak r where r.optionalLookupDefSchema.requiredId = :defSchemaId")
	List<CFBamJpaIndexTweak> lockByDefSchemaIdx(@Param("defSchemaId") CFLibDbKeyHash256 optionalDefSchemaId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaTweak r where r.requiredTenantId = :tenantId and r.requiredContainerScopeDef.requiredId = :scopeId and r.optionalDefSchemaTenantId = :defSchemaTenantId and r.optionalLookupDefSchema.requiredId = :defSchemaId and r.requiredName = :name")
	CFBamJpaIndexTweak lockByUDefIdx(@Param("tenantId") CFLibDbKeyHash256 requiredTenantId,
		@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("defSchemaTenantId") CFLibDbKeyHash256 optionalDefSchemaTenantId,
		@Param("defSchemaId") CFLibDbKeyHash256 optionalDefSchemaId,
		@Param("name") String requiredName);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaIndexTweak r where r.requiredContainerIndexDef.requiredId = :indexId")
	List<CFBamJpaIndexTweak> lockByIndexIdx(@Param("indexId") CFLibDbKeyHash256 requiredIndexId);
