...
public class CFBamJpaIndexTweakService {
	...
	public CFBamJpaIndexTweak create(CFBamJpaIndexTweak data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31IndexTweakRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaIndexTweak)(cfbam31IndexTweakRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaIndexTweak update(CFBamJpaIndexTweak data) {
		...
		CFBamJpaIndexTweak existing = cfbam31IndexTweakRepository.findById((ICFLibKeyHash256)(data.getPKey()))
