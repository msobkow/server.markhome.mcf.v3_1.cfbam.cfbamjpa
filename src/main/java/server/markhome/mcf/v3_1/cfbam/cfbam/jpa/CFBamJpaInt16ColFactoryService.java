...
// Description: Java 25 Factory service implementation for Int16Col JPA objects
...
/*
 *	Java 25 Factory service implementation for Int16Col JPA objects.
 */
public class CFBamJpaInt16ColFactoryService
    implements ICFBamInt16ColFactory
{
    public CFBamJpaInt16ColFactoryService() { }

    @Override
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
    public ICFBamInt16ColByTableIdxKey newByTableIdxKey() {
		ICFBamInt16ColByTableIdxKey key = new CFBamJpaInt16ColByTableIdxKey();
	return( key );
    }
    ...
    public ICFBamInt16Col newRec() {
        ICFBamInt16Col rec = new CFBamJpaInt16Col();
        return( rec );
    }
    ...
    public ICFBamInt16ColH newHRec() {
        ICFBamInt16ColH hrec = new CFBamJpaInt16ColH();
        return( hrec );
    }
