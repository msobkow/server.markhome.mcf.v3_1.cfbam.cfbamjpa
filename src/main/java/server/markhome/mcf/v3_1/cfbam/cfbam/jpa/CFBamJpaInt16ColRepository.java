...
/**
 *	JpaRepository for the CFBamJpaInt16Col entities defined in server.markhome.mcf.v3_1.cfbam.cfbam.jpa.
 *	The manufactured repositories try to provide a rich, do-it-all interface to the JPA data store, with both object and argument-based implementations of the interface defined.
 */
@Transactional(readOnly = true)
public interface CFBamJpaInt16ColRepository extends JpaRepository<CFBamJpaInt16Col, $implCommaIJavaOptAtomType$> {

	@Transactional
	@Modifying
	CFBamJpaInt16Col save(CFBamJpaInt16Col obj);
	...
	CFBamJpaInt16Col get(@Param("id") ICFLibKeyHash256 requiredId);
	...
	CFBamJpaInt16Col findByUNameIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
	...
	List<CFBamJpaInt16Col> findByScopeIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId);
	...
	List<CFBamJpaInt16Col> findByDefSchemaIdx(@Param("defSchemaId") ICFLibKeyHash256 optionalDefSchemaId);
	...
	List<CFBamJpaInt16Col> findByPrevIdx(@Param("prevId") ICFLibKeyHash256 optionalPrevId);
	...
	List<CFBamJpaInt16Col> findByNextIdx(@Param("nextId") ICFLibKeyHash256 optionalNextId);
	...
	List<CFBamJpaInt16Col> findByContPrevIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
	...
	List<CFBamJpaInt16Col> findByContNextIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
	 ...
	 *		@return List&lt;CFBamJpaInt16Col&gt; of the found entities, typically from the JPA cache, or an empty list if no such entities exist.
	 */
	@Query("select r from CFBamJpaInt16Col r where r.requiredContainerTable.requiredId = :tableId")
	List<CFBamJpaInt16Col> findByTableIdx(@Param("tableId") ICFLibKeyHash256 requiredTableId);
	...
	@Query("select r from CFBamJpaValue r where r.requiredId = :id")
	CFBamJpaInt16Col lockByIdIdx(@Param("id") ICFLibKeyHash256 requiredId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredContainerScope.requiredId = :scopeId and r.requiredName = :name")
	CFBamJpaInt16Col lockByUNameIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
		@Param("name") String requiredName);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredContainerScope.requiredId = :scopeId")
	List<CFBamJpaInt16Col> lockByScopeIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.optionalLookupDefSchema.requiredId = :defSchemaId")
	List<CFBamJpaInt16Col> lockByDefSchemaIdx(@Param("defSchemaId") ICFLibKeyHash256 optionalDefSchemaId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.optionalLookupPrev.requiredId = :prevId")
	List<CFBamJpaInt16Col> lockByPrevIdx(@Param("prevId") ICFLibKeyHash256 optionalPrevId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.optionalLookupNext.requiredId = :nextId")
	List<CFBamJpaInt16Col> lockByNextIdx(@Param("nextId") ICFLibKeyHash256 optionalNextId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredContainerScope.requiredId = :scopeId and r.optionalLookupPrev.requiredId = :prevId")
	List<CFBamJpaInt16Col> lockByContPrevIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
		@Param("prevId") ICFLibKeyHash256 optionalPrevId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredContainerScope.requiredId = :scopeId and r.optionalLookupNext.requiredId = :nextId")
	List<CFBamJpaInt16Col> lockByContNextIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
		@Param("nextId") ICFLibKeyHash256 optionalNextId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaInt16Col r where r.requiredContainerTable.requiredId = :tableId")
	List<CFBamJpaInt16Col> lockByTableIdx(@Param("tableId") ICFLibKeyHash256 requiredTableId);
	...
	@Transactional
	@Modifying
	@Query("delete from CFBamJpaInt16Col r where r.requiredContainerTable.requiredId = :tableId")
