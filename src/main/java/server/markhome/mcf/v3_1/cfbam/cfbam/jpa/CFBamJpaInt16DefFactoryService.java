...
// Description: Java 25 Factory service implementation for Int16Def JPA objects
...
/*
 *	Java 25 Factory service implementation for Int16Def JPA objects.
 */
public class CFBamJpaInt16DefFactoryService
    implements ICFBamInt16DefFactory
{
    ...
    public ICFBamInt16DefH newHRec() {
        ICFBamInt16DefH hrec = new CFBamJpaInt16DefH();
        return( hrec );
    }
