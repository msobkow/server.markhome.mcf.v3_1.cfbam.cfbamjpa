...
// Description: Java 25 Factory service implementation for Int32Col JPA objects
...
/*
 *	Java 25 Factory service implementation for Int32Col JPA objects.
 */
public class CFBamJpaInt32ColFactoryService
    implements ICFBamInt32ColFactory
{
    ...
    public ICFBamInt32ColH newHRec() {
        ICFBamInt32ColH hrec = new CFBamJpaInt32ColH();
        return( hrec );
    }
