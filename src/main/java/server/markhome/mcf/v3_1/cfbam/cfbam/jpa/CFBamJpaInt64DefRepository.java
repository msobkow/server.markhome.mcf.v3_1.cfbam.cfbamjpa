...
/**
 *	JpaRepository for the CFBamJpaInt64Def entities defined in server.markhome.mcf.v3_1.cfbam.cfbam.jpa.
 *	The manufactured repositories try to provide a rich, do-it-all interface to the JPA data store, with both object and argument-based implementations of the interface defined.
 */
@Transactional(readOnly = true)
public interface CFBamJpaInt64DefRepository extends JpaRepository<CFBamJpaInt64Def, $implCommaIJavaOptAtomType$> {

	@Transactional
	@Modifying
	CFBamJpaInt64Def save(CFBamJpaInt64Def obj);
	...
	CFBamJpaInt64Def get(@Param("id") ICFLibKeyHash256 requiredId);
	...
	CFBamJpaInt64Def findByUNameIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
	...
	List<CFBamJpaInt64Def> findByScopeIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId);
	...
	List<CFBamJpaInt64Def> findByDefSchemaIdx(@Param("defSchemaId") ICFLibKeyHash256 optionalDefSchemaId);
	...
	List<CFBamJpaInt64Def> findByPrevIdx(@Param("prevId") ICFLibKeyHash256 optionalPrevId);
	...
	List<CFBamJpaInt64Def> findByNextIdx(@Param("nextId") ICFLibKeyHash256 optionalNextId);
	...
	List<CFBamJpaInt64Def> findByContPrevIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
	...
	List<CFBamJpaInt64Def> findByContNextIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
	...
	@Query("select r from CFBamJpaValue r where r.requiredId = :id")
	CFBamJpaInt64Def lockByIdIdx(@Param("id") ICFLibKeyHash256 requiredId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredContainerScope.requiredId = :scopeId and r.requiredName = :name")
	CFBamJpaInt64Def lockByUNameIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
		@Param("name") String requiredName);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredContainerScope.requiredId = :scopeId")
	List<CFBamJpaInt64Def> lockByScopeIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.optionalLookupDefSchema.requiredId = :defSchemaId")
	List<CFBamJpaInt64Def> lockByDefSchemaIdx(@Param("defSchemaId") ICFLibKeyHash256 optionalDefSchemaId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.optionalLookupPrev.requiredId = :prevId")
	List<CFBamJpaInt64Def> lockByPrevIdx(@Param("prevId") ICFLibKeyHash256 optionalPrevId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.optionalLookupNext.requiredId = :nextId")
	List<CFBamJpaInt64Def> lockByNextIdx(@Param("nextId") ICFLibKeyHash256 optionalNextId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredContainerScope.requiredId = :scopeId and r.optionalLookupPrev.requiredId = :prevId")
	List<CFBamJpaInt64Def> lockByContPrevIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
		@Param("prevId") ICFLibKeyHash256 optionalPrevId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredContainerScope.requiredId = :scopeId and r.optionalLookupNext.requiredId = :nextId")
	List<CFBamJpaInt64Def> lockByContNextIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
		@Param("nextId") ICFLibKeyHash256 optionalNextId);
