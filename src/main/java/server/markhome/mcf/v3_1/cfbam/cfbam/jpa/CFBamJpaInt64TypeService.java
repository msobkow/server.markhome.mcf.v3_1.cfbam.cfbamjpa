...
public class CFBamJpaInt64TypeService {
	...
	public CFBamJpaInt64Type create(CFBamJpaInt64Type data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31Int64TypeRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaInt64Type)(cfbam31Int64TypeRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaInt64Type update(CFBamJpaInt64Type data) {
		...
		CFBamJpaInt64Type existing = cfbam31Int64TypeRepository.findById((ICFLibKeyHash256)(data.getPKey()))
