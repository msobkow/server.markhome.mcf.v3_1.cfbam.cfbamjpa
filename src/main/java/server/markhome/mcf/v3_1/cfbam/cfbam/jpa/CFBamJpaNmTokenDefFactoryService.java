...
// Description: Java 25 Factory service implementation for NmTokenDef JPA objects
...
/*
 *	Java 25 Factory service implementation for NmTokenDef JPA objects.
 */
public class CFBamJpaNmTokenDefFactoryService
    implements ICFBamNmTokenDefFactory
{
    ...
    public ICFBamNmTokenDefH newHRec() {
        ICFBamNmTokenDefH hrec = new CFBamJpaNmTokenDefH();
        return( hrec );
    }
