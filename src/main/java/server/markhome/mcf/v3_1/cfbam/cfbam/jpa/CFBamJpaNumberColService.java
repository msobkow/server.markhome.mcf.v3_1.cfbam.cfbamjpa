...
public class CFBamJpaNumberColService {
	...
	public CFBamJpaNumberCol create(CFBamJpaNumberCol data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31NumberColRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaNumberCol)(cfbam31NumberColRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaNumberCol update(CFBamJpaNumberCol data) {
		...
		CFBamJpaNumberCol existing = cfbam31NumberColRepository.findById((ICFLibKeyHash256)(data.getPKey()))
