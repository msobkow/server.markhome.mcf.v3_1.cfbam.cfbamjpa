...
public class CFBamJpaNumberTypeService {
	...
	public CFBamJpaNumberType create(CFBamJpaNumberType data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31NumberTypeRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaNumberType)(cfbam31NumberTypeRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaNumberType update(CFBamJpaNumberType data) {
		...
		CFBamJpaNumberType existing = cfbam31NumberTypeRepository.findById((ICFLibKeyHash256)(data.getPKey()))
