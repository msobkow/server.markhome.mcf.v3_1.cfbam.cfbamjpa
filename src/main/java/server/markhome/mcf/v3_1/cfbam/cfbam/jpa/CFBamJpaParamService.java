...
public class CFBamJpaParamService {
	...
	public CFBamJpaParam create(CFBamJpaParam data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31ParamRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaParam)(cfbam31ParamRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaParam update(CFBamJpaParam data) {
		...
		CFBamJpaParam existing = cfbam31ParamRepository.findById((ICFLibKeyHash256)(data.getPKey()))
