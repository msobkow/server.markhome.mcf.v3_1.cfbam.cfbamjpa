...
@Table(
	...
	indexes = {
		...
		@Index(name = "PopDepRelationIdxRelation", columnList = "RelationIdRelation", unique = false),
		@Index(name = "PopDepDefSchemaDefIdxDefSchema", columnList = "defschidDefSchema", unique = false)
	}
)
