...
public class CFBamJpaPopDepService {
	...
	public CFBamJpaPopDep create(CFBamJpaPopDep data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31PopDepRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaPopDep)(cfbam31PopDepRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaPopDep update(CFBamJpaPopDep data) {
		...
		CFBamJpaPopDep existing = cfbam31PopDepRepository.findById((ICFLibKeyHash256)(data.getPKey()))
