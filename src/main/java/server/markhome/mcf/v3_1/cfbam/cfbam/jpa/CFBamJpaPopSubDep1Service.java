...
public class CFBamJpaPopSubDep1Service {
	...
	public CFBamJpaPopSubDep1 create(CFBamJpaPopSubDep1 data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31PopSubDep1Repository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaPopSubDep1)(cfbam31PopSubDep1Repository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaPopSubDep1 update(CFBamJpaPopSubDep1 data) {
		...
		CFBamJpaPopSubDep1 existing = cfbam31PopSubDep1Repository.findById((ICFLibKeyHash256)(data.getPKey()))
