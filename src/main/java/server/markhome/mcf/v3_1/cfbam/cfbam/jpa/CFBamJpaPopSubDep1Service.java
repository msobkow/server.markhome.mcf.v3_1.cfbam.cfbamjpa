...
public class CFBamJpaPopSubDep1Service {
	...
	public CFBamJpaPopSubDep1 create(CFBamJpaPopSubDep1 data) {
		...
		if (data.getRequiredContainerContPopTopDep() == null) {
			throw new CFLibUnresolvedRelationException(getClass(),
				S_ProcName,
				"Container",
				"Container",
				"data.requiredContainerContPopTopDep",
				"data.requiredContainerContPopTopDep",
				"PopTopDep",
				"PopTopDep",
				null);
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31PopSubDep1Repository.existsById(($implCommaIJavaOptAtomType$)data.getPKey())) {
				return( (CFBamJpaPopSubDep1)(cfbam31PopSubDep1Repository.findById(($implCommaIJavaOptAtomType$)(data.getPKey())).get()));
			}
	...
	public CFBamJpaPopSubDep1 update(CFBamJpaPopSubDep1 data) {
		...
		CFBamJpaPopSubDep1 existing = cfbam31PopSubDep1Repository.findById(($implCommaIJavaOptAtomType$)(data.getPKey()))
	...
	public CFBamJpaPopSubDep1 find(@Param("id") ICFLibKeyHash256 requiredId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaPopSubDep1> findByTenantIdx(@Param("tenantId") ICFLibKeyHash256 requiredTenantId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaPopSubDep1> findByRelationIdx(@Param("relationId") ICFLibKeyHash256 requiredRelationId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaPopSubDep1> findByDefSchemaIdx(@Param("defSchemaId") ICFLibKeyHash256 optionalDefSchemaId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaPopSubDep1> findByPopTopDepIdx(@Param("popTopDepId") ICFLibKeyHash256 requiredPopTopDepId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public CFBamJpaPopSubDep1 findByUNameIdx(@Param("popTopDepId") ICFLibKeyHash256 requiredPopTopDepId,
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public CFBamJpaPopSubDep1 lockByIdIdx(@Param("id") ICFLibKeyHash256 requiredId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaPopSubDep1> lockByTenantIdx(@Param("tenantId") ICFLibKeyHash256 requiredTenantId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaPopSubDep1> lockByRelationIdx(@Param("relationId") ICFLibKeyHash256 requiredRelationId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaPopSubDep1> lockByDefSchemaIdx(@Param("defSchemaId") ICFLibKeyHash256 optionalDefSchemaId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaPopSubDep1> lockByPopTopDepIdx(@Param("popTopDepId") ICFLibKeyHash256 requiredPopTopDepId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public CFBamJpaPopSubDep1 lockByUNameIdx(@Param("popTopDepId") ICFLibKeyHash256 requiredPopTopDepId,
		@Param("name") String requiredName) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public void deleteByPopTopDepIdx(@Param("popTopDepId") ICFLibKeyHash256 requiredPopTopDepId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public void deleteByUNameIdx(@Param("popTopDepId") ICFLibKeyHash256 requiredPopTopDepId,
		@Param("name") String requiredName) {
