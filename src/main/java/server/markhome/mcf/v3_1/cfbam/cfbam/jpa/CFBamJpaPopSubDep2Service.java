...
public class CFBamJpaPopSubDep2Service {
	...
	public CFBamJpaPopSubDep2 create(CFBamJpaPopSubDep2 data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31PopSubDep2Repository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaPopSubDep2)(cfbam31PopSubDep2Repository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaPopSubDep2 update(CFBamJpaPopSubDep2 data) {
		...
		CFBamJpaPopSubDep2 existing = cfbam31PopSubDep2Repository.findById((ICFLibKeyHash256)(data.getPKey()))
