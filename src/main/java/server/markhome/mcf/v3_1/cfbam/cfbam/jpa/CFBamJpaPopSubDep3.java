...
@Table(
	...
	indexes = {
		...
		@Index(name = "PopSubDep3PopSubDep2IdxPopSubDep2", columnList = "contpopdep2idPopSubDep2", unique = false)
	}
)
	...
	implements ICFBamPopSubDep3
{
	...
	@JoinColumn( name="contpopdep2idPopSubDep2", referencedColumnName="Id" )
	...
	public void setRequiredContainerPopSubDep2(ICFBamPopSubDep2 argObj) {
		if(argObj == null) {
			...
			if (requiredContainerPopSubDep2 != null) {
				requiredPopSubDep2Id = requiredContainerPopSubDep2.getRequiredId();
			}
			else {
			}
		}
	...
	public void setRequiredContainerPopSubDep2(CFLibDbKeyHash256 argPopSubDep2Id) {
		...
		ICFBamPopSubDep2 targetRec = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argPopSubDep2Id);
