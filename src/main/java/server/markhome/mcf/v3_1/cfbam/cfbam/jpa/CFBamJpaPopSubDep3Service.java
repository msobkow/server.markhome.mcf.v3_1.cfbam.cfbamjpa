...
public class CFBamJpaPopSubDep3Service {
	...
	public CFBamJpaPopSubDep3 create(CFBamJpaPopSubDep3 data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31PopSubDep3Repository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaPopSubDep3)(cfbam31PopSubDep3Repository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaPopSubDep3 update(CFBamJpaPopSubDep3 data) {
		...
		CFBamJpaPopSubDep3 existing = cfbam31PopSubDep3Repository.findById((ICFLibKeyHash256)(data.getPKey()))
