...
// Description: Java 25 Factory service implementation for PopTopDep JPA objects
...
/*
 *	Java 25 Factory service implementation for PopTopDep JPA objects.
 */
public class CFBamJpaPopTopDepFactoryService
    implements ICFBamPopTopDepFactory
{
    ...
    public ICFBamPopTopDepH newHRec() {
        ICFBamPopTopDepH hrec = new CFBamJpaPopTopDepH();
        return( hrec );
    }
