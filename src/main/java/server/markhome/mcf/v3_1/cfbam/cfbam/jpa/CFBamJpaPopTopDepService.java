...
public class CFBamJpaPopTopDepService {
	...
	public CFBamJpaPopTopDep create(CFBamJpaPopTopDep data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31PopTopDepRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaPopTopDep)(cfbam31PopTopDepRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaPopTopDep update(CFBamJpaPopTopDep data) {
		...
		CFBamJpaPopTopDep existing = cfbam31PopTopDepRepository.findById((ICFLibKeyHash256)(data.getPKey()))
