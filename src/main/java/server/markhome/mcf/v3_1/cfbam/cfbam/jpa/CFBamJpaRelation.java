	...
	implements ICFBamRelation
{
	...
	public void setRequiredContainerFromTable(ICFBamTable argObj) {
		if(argObj == null) {
			...
			if (requiredContainerFromTable != null) {
				requiredTableId = requiredContainerFromTable.getRequiredId();
			}
			else {
			}
		}
	...
	public void setRequiredLookupFromIndex(ICFBamIndex argObj) {
		if(argObj == null) {
			...
			if (requiredLookupFromIndex != null) {
				requiredFromIndexId = requiredLookupFromIndex.getRequiredId();
			}
			else {
			}
		}
	...
	public void setRequiredLookupFromIndex(CFLibDbKeyHash256 argFromIndexId) {
		...
		ICFBamIndex targetRec = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argFromIndexId);
	...
	public void setRequiredLookupToTable(ICFBamTable argObj) {
		if(argObj == null) {
			...
			if (requiredLookupToTable != null) {
				requiredToTableId = requiredLookupToTable.getRequiredId();
			}
			else {
			}
		}
	...
	public void setRequiredLookupToTable(CFLibDbKeyHash256 argToTableId) {
		...
		ICFBamTable targetRec = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argToTableId);
	...
	public void setRequiredLookupToIndex(ICFBamIndex argObj) {
		if(argObj == null) {
			...
			if (requiredLookupToIndex != null) {
				requiredToIndexId = requiredLookupToIndex.getRequiredId();
			}
			else {
			}
		}
	...
	public void setRequiredLookupToIndex(CFLibDbKeyHash256 argToIndexId) {
		...
		ICFBamIndex targetRec = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argToIndexId);
	...
	public void setOptionalLookupNarrowed(ICFBamRelation argObj) {
		if(argObj == null) {
			...
			if (optionalLookupNarrowed != null) {
				optionalNarrowedId = optionalLookupNarrowed.getRequiredId();
			}
			else {
	...
	public void setOptionalLookupNarrowed(CFLibDbKeyHash256 argNarrowedId) {
		...
		ICFBamRelation targetRec = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argNarrowedId);
		setOptionalLookupNarrowed(targetRec);
	}

	@Override
	public List<ICFBamRelationCol> getOptionalComponentsColumns() {
		List<ICFBamRelationCol> retlist = (optionalComponentsColumns != null) ? new ArrayList<>(optionalComponentsColumns) : new ArrayList<>();
		return( retlist );
	}

	@Override
	public List<ICFBamPopTopDep> getOptionalComponentsPopDep() {
		List<ICFBamPopTopDep> retlist = (optionalComponentsPopDep != null) ? new ArrayList<>(optionalComponentsPopDep) : new ArrayList<>();
		return( retlist );
	}
