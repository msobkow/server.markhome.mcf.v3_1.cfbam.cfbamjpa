...
// Description: Java 25 Factory service implementation for RelationCol JPA objects
...
/*
 *	Java 25 Factory service implementation for RelationCol JPA objects.
 */
public class CFBamJpaRelationColFactoryService
    implements ICFBamRelationColFactory
{
    ...
    public ICFBamRelationColH newHRec() {
        ICFBamRelationColH hrec = new CFBamJpaRelationColH();
        return( hrec );
    }
