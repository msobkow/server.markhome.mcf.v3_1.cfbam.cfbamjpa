...
public class CFBamJpaRelationColService {
	...
	public CFBamJpaRelationCol create(CFBamJpaRelationCol data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31RelationColRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaRelationCol)(cfbam31RelationColRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaRelationCol update(CFBamJpaRelationCol data) {
		...
		CFBamJpaRelationCol existing = cfbam31RelationColRepository.findById((ICFLibKeyHash256)(data.getPKey()))
