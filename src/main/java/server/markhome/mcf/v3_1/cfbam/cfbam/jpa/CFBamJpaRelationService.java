...
public class CFBamJpaRelationService {
	...
	public CFBamJpaRelation create(CFBamJpaRelation data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31RelationRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaRelation)(cfbam31RelationRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaRelation update(CFBamJpaRelation data) {
		...
		CFBamJpaRelation existing = cfbam31RelationRepository.findById((ICFLibKeyHash256)(data.getPKey()))
