...
public class CFBamJpaRelationService {
	...
	public CFBamJpaRelation create(CFBamJpaRelation data) {
		...
		if (data.getRequiredContainerFromTable() == null) {
			throw new CFLibUnresolvedRelationException(getClass(),
				S_ProcName,
				"Container",
				"Container",
				"data.requiredContainerFromTable",
				"data.requiredContainerFromTable",
				"Table",
				"Table",
				null);
		}
		if (data.getRequiredLookupFromIndex() == null) {
			throw new CFLibUnresolvedRelationException(getClass(),
				S_ProcName,
				"Lookup",
				"Lookup",
				"data.requiredLookupFromIndex",
				"data.requiredLookupFromIndex",
				"Index",
				"Index",
				null);
		}
		if (data.getRequiredLookupToTable() == null) {
			throw new CFLibUnresolvedRelationException(getClass(),
				S_ProcName,
				"Lookup",
				"Lookup",
				"data.requiredLookupToTable",
				"data.requiredLookupToTable",
				"Table",
				"Table",
				null);
		}
		if (data.getRequiredLookupToIndex() == null) {
			throw new CFLibUnresolvedRelationException(getClass(),
				S_ProcName,
				"Lookup",
				"Lookup",
				"data.requiredLookupToIndex",
				"data.requiredLookupToIndex",
				"Index",
				"Index",
				null);
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31RelationRepository.existsById(($implCommaIJavaOptAtomType$)data.getPKey())) {
				return( (CFBamJpaRelation)(cfbam31RelationRepository.findById(($implCommaIJavaOptAtomType$)(data.getPKey())).get()));
			}
	...
	public CFBamJpaRelation update(CFBamJpaRelation data) {
		...
		CFBamJpaRelation existing = cfbam31RelationRepository.findById(($implCommaIJavaOptAtomType$)(data.getPKey()))
	...
	public CFBamJpaRelation find(@Param("id") ICFLibKeyHash256 requiredId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaRelation> findByTenantIdx(@Param("tenantId") ICFLibKeyHash256 requiredTenantId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public CFBamJpaRelation findByUNameIdx(@Param("tableId") ICFLibKeyHash256 requiredTableId,
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaRelation> findByRelTableIdx(@Param("tableId") ICFLibKeyHash256 requiredTableId) {
	...
	/**
	 *	Find zero or more entities into a List using the columns of the ICFBamRelationByRelCodeVisIdxKey as arguments.
	 *
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaRelation> findByRelCodeVisIdx(@Param("codeVis") ICFBamPubSchema.CodeVisibilityEnum requiredCodeVis) {
		return( cfbam31RelationRepository.findByRelCodeVisIdx(requiredCodeVis));
	}

	/**
	 *	ICFBamRelationByRelCodeVisIdxKey entity list finder convenience method for object-based access.
	 *
	 *		@param key The ICFBamRelationByRelCodeVisIdxKey instance to use for the query arguments.
	 *
	 *		@return The found entity list, which may be empty.
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaRelation> findByRelCodeVisIdx(ICFBamRelationByRelCodeVisIdxKey key) {
		return( cfbam31RelationRepository.findByRelCodeVisIdx(key.getRequiredCodeVis()));
	}

	/**
	 *	Find zero or more entities into a List using the columns of the ICFBamRelationByRelTableCodeVisXKey as arguments.
	 *
	 *		@param requiredTableId
	 *		@param requiredCodeVis
	 *
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaRelation> findByRelTableCodeVisX(@Param("tableId") ICFLibKeyHash256 requiredTableId,
		@Param("codeVis") ICFBamPubSchema.CodeVisibilityEnum requiredCodeVis) {
		return( cfbam31RelationRepository.findByRelTableCodeVisX(requiredTableId,
			requiredCodeVis));
	}

	/**
	 *	ICFBamRelationByRelTableCodeVisXKey entity list finder convenience method for object-based access.
	 *
	 *		@param key The ICFBamRelationByRelTableCodeVisXKey instance to use for the query arguments.
	 *
	 *		@return The found entity list, which may be empty.
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaRelation> findByRelTableCodeVisX(ICFBamRelationByRelTableCodeVisXKey key) {
		return( cfbam31RelationRepository.findByRelTableCodeVisX(key.getRequiredTableId(), key.getRequiredCodeVis()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaRelation> findByDefSchemaIdx(@Param("defSchemaId") ICFLibKeyHash256 optionalDefSchemaId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaRelation> findByFromKeyIdx(@Param("fromIndexId") ICFLibKeyHash256 requiredFromIndexId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaRelation> findByToTblIdx(@Param("toTableId") ICFLibKeyHash256 requiredToTableId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaRelation> findByToKeyIdx(@Param("toIndexId") ICFLibKeyHash256 requiredToIndexId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaRelation> findByNarrowedIdx(@Param("narrowedId") ICFLibKeyHash256 optionalNarrowedId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public CFBamJpaRelation lockByIdIdx(@Param("id") ICFLibKeyHash256 requiredId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaRelation> lockByTenantIdx(@Param("tenantId") ICFLibKeyHash256 requiredTenantId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public CFBamJpaRelation lockByUNameIdx(@Param("tableId") ICFLibKeyHash256 requiredTableId,
		@Param("name") String requiredName) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaRelation> lockByRelTableIdx(@Param("tableId") ICFLibKeyHash256 requiredTableId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaRelation> lockByRelCodeVisIdx(@Param("codeVis") ICFBamPubSchema.CodeVisibilityEnum requiredCodeVis) {
		return( cfbam31RelationRepository.lockByRelCodeVisIdx(requiredCodeVis));
	}

	/**
	 *	ICFBamRelationByRelCodeVisIdxKey based lock method for object-based access.
	 *
	 *		@param key The key of the entity to be locked.
	 *
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaRelation> lockByRelCodeVisIdx(ICFBamRelationByRelCodeVisIdxKey key) {
		return( cfbam31RelationRepository.lockByRelCodeVisIdx(key.getRequiredCodeVis()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaRelation> lockByRelTableCodeVisX(@Param("tableId") ICFLibKeyHash256 requiredTableId,
		@Param("codeVis") ICFBamPubSchema.CodeVisibilityEnum requiredCodeVis) {
		return( cfbam31RelationRepository.lockByRelTableCodeVisX(requiredTableId,
			requiredCodeVis));
	}

	/**
	 *	ICFBamRelationByRelTableCodeVisXKey based lock method for object-based access.
	 *
	 *		@param key The key of the entity to be locked.
	 *
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaRelation> lockByRelTableCodeVisX(ICFBamRelationByRelTableCodeVisXKey key) {
		return( cfbam31RelationRepository.lockByRelTableCodeVisX(key.getRequiredTableId(), key.getRequiredCodeVis()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaRelation> lockByDefSchemaIdx(@Param("defSchemaId") ICFLibKeyHash256 optionalDefSchemaId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaRelation> lockByFromKeyIdx(@Param("fromIndexId") ICFLibKeyHash256 requiredFromIndexId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaRelation> lockByToTblIdx(@Param("toTableId") ICFLibKeyHash256 requiredToTableId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaRelation> lockByToKeyIdx(@Param("toIndexId") ICFLibKeyHash256 requiredToIndexId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaRelation> lockByNarrowedIdx(@Param("narrowedId") ICFLibKeyHash256 optionalNarrowedId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public void deleteByUNameIdx(@Param("tableId") ICFLibKeyHash256 requiredTableId,
		@Param("name") String requiredName) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public void deleteByRelTableIdx(@Param("tableId") ICFLibKeyHash256 requiredTableId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public void deleteByRelCodeVisIdx(@Param("codeVis") ICFBamPubSchema.CodeVisibilityEnum requiredCodeVis) {
		cfbam31RelationRepository.deleteByRelCodeVisIdx(requiredCodeVis);
	}

	/**
	 *	ICFBamRelationByRelCodeVisIdxKey based lock method for object-based access.
	 *
	 *		@param key The ICFBamRelationByRelCodeVisIdxKey of the entity to be locked.
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public void deleteByRelCodeVisIdx(ICFBamRelationByRelCodeVisIdxKey key) {
		cfbam31RelationRepository.deleteByRelCodeVisIdx(key.getRequiredCodeVis());
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public void deleteByRelTableCodeVisX(@Param("tableId") ICFLibKeyHash256 requiredTableId,
		@Param("codeVis") ICFBamPubSchema.CodeVisibilityEnum requiredCodeVis) {
		cfbam31RelationRepository.deleteByRelTableCodeVisX(requiredTableId,
			requiredCodeVis);
	}
	 ...
	 *	ICFBamRelationByRelTableCodeVisXKey based lock method for object-based access.
	 *
	 *		@param key The ICFBamRelationByRelTableCodeVisXKey of the entity to be locked.
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public void deleteByRelTableCodeVisX(ICFBamRelationByRelTableCodeVisXKey key) {
		cfbam31RelationRepository.deleteByRelTableCodeVisX(key.getRequiredTableId(), key.getRequiredCodeVis());
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public void deleteByFromKeyIdx(@Param("fromIndexId") ICFLibKeyHash256 requiredFromIndexId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public void deleteByToTblIdx(@Param("toTableId") ICFLibKeyHash256 requiredToTableId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public void deleteByToKeyIdx(@Param("toIndexId") ICFLibKeyHash256 requiredToIndexId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public void deleteByNarrowedIdx(@Param("narrowedId") ICFLibKeyHash256 optionalNarrowedId) {
