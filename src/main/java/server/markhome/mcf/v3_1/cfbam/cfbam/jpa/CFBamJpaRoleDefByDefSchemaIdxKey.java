// Description: Java 25 JPA implementation of a RoleDef by DefSchemaIdx index key object.
	...
	implements ICFBamRoleDefByDefSchemaIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamRoleDefByDefSchemaIdxKey, ICFBamRoleDef$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamRoleDefByDefSchemaIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
