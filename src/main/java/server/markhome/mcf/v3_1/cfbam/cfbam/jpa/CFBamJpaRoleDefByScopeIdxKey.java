// Description: Java 25 JPA implementation of a RoleDef by ScopeIdx index key object.
	...
	implements ICFBamRoleDefByScopeIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamRoleDefByScopeIdxKey, ICFBamRoleDef$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamRoleDefByScopeIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
