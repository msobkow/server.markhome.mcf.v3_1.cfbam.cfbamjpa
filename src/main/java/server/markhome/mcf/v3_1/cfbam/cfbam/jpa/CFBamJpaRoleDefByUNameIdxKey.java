// Description: Java 25 JPA implementation of a RoleDef by UNameIdx index key object.
	...
	implements ICFBamRoleDefByUNameIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamRoleDefByUNameIdxKey, ICFBamRoleDef$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamRoleDefByUNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
