...
// Description: Java 25 Factory service implementation for RoleDef JPA objects
...
/*
 *	Java 25 Factory service implementation for RoleDef JPA objects.
 */
public class CFBamJpaRoleDefFactoryService
    implements ICFBamRoleDefFactory
{
    ...
    public ICFBamRoleDefH newHRec() {
        ICFBamRoleDefH hrec = new CFBamJpaRoleDefH();
        return( hrec );
    }
