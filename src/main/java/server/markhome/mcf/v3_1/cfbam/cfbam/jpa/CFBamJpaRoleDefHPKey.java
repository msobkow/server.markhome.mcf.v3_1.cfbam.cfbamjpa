// Description: Java 25 JPA implementation of a RoleDef history primary key object.
...
/**
 *	CFBamJpaRoleDefHPKey History Primary Key for RoleDef
 *		requiredId	Required object attribute Id.
 */
public class CFBamJpaRoleDefHPKey
	implements ICFBamRoleDefHPKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFBamJpaRoleDefHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
