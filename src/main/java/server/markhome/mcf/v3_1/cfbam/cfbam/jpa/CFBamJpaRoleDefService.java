...
public class CFBamJpaRoleDefService {
	...
	public CFBamJpaRoleDef create(CFBamJpaRoleDef data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31RoleDefRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaRoleDef)(cfbam31RoleDefRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaRoleDef update(CFBamJpaRoleDef data) {
		...
		CFBamJpaRoleDef existing = cfbam31RoleDefRepository.findById((ICFLibKeyHash256)(data.getPKey()))
