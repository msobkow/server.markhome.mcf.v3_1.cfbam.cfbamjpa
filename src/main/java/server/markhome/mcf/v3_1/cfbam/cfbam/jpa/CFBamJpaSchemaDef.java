	...
	implements ICFBamSchemaDef
{
	...
	@OneToMany(fetch=FetchType.LAZY, mappedBy="requiredContainerSchemaDef")
	protected Set<CFBamJpaSchemaRole> optionalComponentsRoles;
	...
	public List<ICFBamTable> getOptionalComponentsTables() {
		List<ICFBamTable> retlist = (optionalComponentsTables != null) ? new ArrayList<>(optionalComponentsTables) : new ArrayList<>();
		return( retlist );
	}

	@Override
	public List<ICFBamValue> getOptionalComponentsTypes() {
		List<ICFBamValue> retlist = (optionalComponentsTypes != null) ? new ArrayList<>(optionalComponentsTypes) : new ArrayList<>();
		return( retlist );
	}

	@Override
	public List<ICFBamSchemaRef> getOptionalComponentsSchemaRefs() {
		List<ICFBamSchemaRef> retlist = (optionalComponentsSchemaRefs != null) ? new ArrayList<>(optionalComponentsSchemaRefs) : new ArrayList<>();
		return( retlist );
	}
	...
	public List<ICFBamSchemaRole> getOptionalComponentsRoles() {
		List<ICFBamSchemaRole> retlist = (optionalComponentsRoles != null) ? new ArrayList<>(optionalComponentsRoles) : new ArrayList<>();
		return( retlist );
	}
