...
public class CFBamJpaSchemaDefService {
	...
	public CFBamJpaSchemaDef create(CFBamJpaSchemaDef data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31SchemaDefRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaSchemaDef)(cfbam31SchemaDefRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaSchemaDef update(CFBamJpaSchemaDef data) {
		...
		CFBamJpaSchemaDef existing = cfbam31SchemaDefRepository.findById((ICFLibKeyHash256)(data.getPKey()))
