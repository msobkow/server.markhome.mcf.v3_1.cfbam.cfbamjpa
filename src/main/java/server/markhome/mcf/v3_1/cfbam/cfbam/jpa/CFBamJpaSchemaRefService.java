...
public class CFBamJpaSchemaRefService {
	...
	public CFBamJpaSchemaRef create(CFBamJpaSchemaRef data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31SchemaRefRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaSchemaRef)(cfbam31SchemaRefRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaSchemaRef update(CFBamJpaSchemaRef data) {
		...
		CFBamJpaSchemaRef existing = cfbam31SchemaRefRepository.findById((ICFLibKeyHash256)(data.getPKey()))
