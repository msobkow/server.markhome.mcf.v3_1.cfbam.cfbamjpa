// Description: Java 25 JPA implementation of a SchemaRole entity definition object.
...
public class CFBamJpaSchemaRole extends CFBamJpaRoleDef
	implements ICFBamSchemaRole
{
	...
	public String toString() {
		String ret = "<CFBamJpaSchemaRole" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
