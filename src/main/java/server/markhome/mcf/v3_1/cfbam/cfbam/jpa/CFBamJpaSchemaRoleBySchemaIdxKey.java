// Description: Java 25 JPA implementation of a SchemaRole by SchemaIdx index key object.
	...
	implements ICFBamSchemaRoleBySchemaIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamSchemaRoleBySchemaIdxKey, ICFBamSchemaRole$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamSchemaRoleBySchemaIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
