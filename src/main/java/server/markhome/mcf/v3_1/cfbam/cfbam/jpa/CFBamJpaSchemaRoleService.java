...
public class CFBamJpaSchemaRoleService {
	...
	public CFBamJpaSchemaRole create(CFBamJpaSchemaRole data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31SchemaRoleRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaSchemaRole)(cfbam31SchemaRoleRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaSchemaRole update(CFBamJpaSchemaRole data) {
		...
		CFBamJpaSchemaRole existing = cfbam31SchemaRoleRepository.findById((ICFLibKeyHash256)(data.getPKey()))
