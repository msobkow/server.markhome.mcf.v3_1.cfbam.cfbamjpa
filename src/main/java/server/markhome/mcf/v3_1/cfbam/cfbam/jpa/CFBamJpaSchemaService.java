...
//ICFSecSchema.getSysTenantId(), ICFSecSchema.getSysAdminId()
		...
		bootstrapTableSecurity(auth, "Scope", true, false, "Tenant");
		bootstrapTableSecurity(auth, "SchemaDef", true, false, "Tenant");
		bootstrapTableSecurity(auth, "SchemaRef", true, false, "Tenant");
		bootstrapTableSecurity(auth, "ServerMethod", true, false, "Tenant");
		...
		bootstrapTableSecurity(auth, "BlobType", true, false, "Tenant");
		bootstrapTableSecurity(auth, "BoolDef", true, false, "Tenant");
		bootstrapTableSecurity(auth, "BoolType", true, false, "Tenant");
		bootstrapTableSecurity(auth, "Chain", true, false, "Tenant");
		bootstrapTableSecurity(auth, "ClearDep", true, false, "Tenant");
		bootstrapTableSecurity(auth, "ClearSubDep1", true, false, "Tenant");
		bootstrapTableSecurity(auth, "ClearSubDep2", true, false, "Tenant");
		bootstrapTableSecurity(auth, "ClearSubDep3", true, false, "Tenant");
		bootstrapTableSecurity(auth, "ClearTopDep", true, false, "Tenant");
		bootstrapTableSecurity(auth, "DateDef", true, false, "Tenant");
		bootstrapTableSecurity(auth, "DateType", true, false, "Tenant");
		bootstrapTableSecurity(auth, "DelDep", true, false, "Tenant");
		bootstrapTableSecurity(auth, "DelSubDep1", true, false, "Tenant");
		bootstrapTableSecurity(auth, "DelSubDep2", true, false, "Tenant");
		bootstrapTableSecurity(auth, "DelSubDep3", true, false, "Tenant");
		bootstrapTableSecurity(auth, "DelTopDep", true, false, "Tenant");
		bootstrapTableSecurity(auth, "DoubleDef", true, false, "Tenant");
		bootstrapTableSecurity(auth, "DoubleType", true, false, "Tenant");
		bootstrapTableSecurity(auth, "EnumTag", true, false, "Tenant");
		bootstrapTableSecurity(auth, "FloatDef", true, false, "Tenant");
		bootstrapTableSecurity(auth, "FloatType", true, false, "Tenant");
		bootstrapTableSecurity(auth, "Index", true, false, "Tenant");
		bootstrapTableSecurity(auth, "IndexCol", true, false, "Tenant");
		bootstrapTableSecurity(auth, "Int16Def", true, false, "Tenant");
		bootstrapTableSecurity(auth, "Int16Type", true, false, "Tenant");
		bootstrapTableSecurity(auth, "Int32Def", true, false, "Tenant");
		bootstrapTableSecurity(auth, "Int32Type", true, false, "Tenant");
		bootstrapTableSecurity(auth, "Int64Def", true, false, "Tenant");
		bootstrapTableSecurity(auth, "Int64Type", true, false, "Tenant");
		bootstrapTableSecurity(auth, "NmTokenDef", true, false, "Tenant");
		bootstrapTableSecurity(auth, "NmTokenType", true, false, "Tenant");
		bootstrapTableSecurity(auth, "NmTokensDef", true, false, "Tenant");
		bootstrapTableSecurity(auth, "NmTokensType", true, false, "Tenant");
		bootstrapTableSecurity(auth, "NumberDef", true, false, "Tenant");
		bootstrapTableSecurity(auth, "NumberType", true, false, "Tenant");
		bootstrapTableSecurity(auth, "Param", true, false, "Tenant");
		bootstrapTableSecurity(auth, "PopDep", true, false, "Tenant");
		bootstrapTableSecurity(auth, "PopSubDep1", true, false, "Tenant");
		bootstrapTableSecurity(auth, "PopSubDep2", true, false, "Tenant");
		bootstrapTableSecurity(auth, "PopSubDep3", true, false, "Tenant");
		bootstrapTableSecurity(auth, "PopTopDep", true, false, "Tenant");
		bootstrapTableSecurity(auth, "Relation", true, false, "Tenant");
		bootstrapTableSecurity(auth, "RelationCol", true, false, "Tenant");
		bootstrapTableSecurity(auth, "ServerListFunc", true, false, "Tenant");
		bootstrapTableSecurity(auth, "DbKeyHash128Def", true, false, "Tenant");
		bootstrapTableSecurity(auth, "DbKeyHash128Col", true, false, "Tenant");
		bootstrapTableSecurity(auth, "DbKeyHash128Type", true, false, "Tenant");
		bootstrapTableSecurity(auth, "DbKeyHash128Gen", true, false, "Tenant");
		bootstrapTableSecurity(auth, "DbKeyHash160Def", true, false, "Tenant");
		bootstrapTableSecurity(auth, "DbKeyHash160Col", true, false, "Tenant");
		bootstrapTableSecurity(auth, "DbKeyHash160Type", true, false, "Tenant");
		bootstrapTableSecurity(auth, "DbKeyHash160Gen", true, false, "Tenant");
		bootstrapTableSecurity(auth, "DbKeyHash224Def", true, false, "Tenant");
		bootstrapTableSecurity(auth, "DbKeyHash224Col", true, false, "Tenant");
		bootstrapTableSecurity(auth, "DbKeyHash224Type", true, false, "Tenant");
		bootstrapTableSecurity(auth, "DbKeyHash224Gen", true, false, "Tenant");
		bootstrapTableSecurity(auth, "DbKeyHash256Def", true, false, "Tenant");
		bootstrapTableSecurity(auth, "DbKeyHash256Col", true, false, "Tenant");
		bootstrapTableSecurity(auth, "DbKeyHash256Type", true, false, "Tenant");
		bootstrapTableSecurity(auth, "DbKeyHash256Gen", true, false, "Tenant");
		bootstrapTableSecurity(auth, "DbKeyHash384Def", true, false, "Tenant");
		bootstrapTableSecurity(auth, "DbKeyHash384Col", true, false, "Tenant");
		bootstrapTableSecurity(auth, "DbKeyHash384Type", true, false, "Tenant");
		bootstrapTableSecurity(auth, "DbKeyHash384Gen", true, false, "Tenant");
		bootstrapTableSecurity(auth, "DbKeyHash512Def", true, false, "Tenant");
		bootstrapTableSecurity(auth, "DbKeyHash512Col", true, false, "Tenant");
		bootstrapTableSecurity(auth, "DbKeyHash512Type", true, false, "Tenant");
		bootstrapTableSecurity(auth, "DbKeyHash512Gen", true, false, "Tenant");
		bootstrapTableSecurity(auth, "StringDef", true, false, "Tenant");
		bootstrapTableSecurity(auth, "StringType", true, false, "Tenant");
		bootstrapTableSecurity(auth, "TZDateDef", true, false, "Tenant");
		bootstrapTableSecurity(auth, "TZDateType", true, false, "Tenant");
		bootstrapTableSecurity(auth, "TZTimeDef", true, false, "Tenant");
		bootstrapTableSecurity(auth, "TZTimeType", true, false, "Tenant");
		bootstrapTableSecurity(auth, "TZTimestampDef", true, false, "Tenant");
		bootstrapTableSecurity(auth, "TZTimestampType", true, false, "Tenant");
		bootstrapTableSecurity(auth, "TableCol", true, false, "Tenant");
		bootstrapTableSecurity(auth, "TextDef", true, false, "Tenant");
		bootstrapTableSecurity(auth, "TextType", true, false, "Tenant");
		bootstrapTableSecurity(auth, "TimeDef", true, false, "Tenant");
		bootstrapTableSecurity(auth, "TimeType", true, false, "Tenant");
		bootstrapTableSecurity(auth, "TimestampDef", true, false, "Tenant");
		bootstrapTableSecurity(auth, "TimestampType", true, false, "Tenant");
		bootstrapTableSecurity(auth, "TokenDef", true, false, "Tenant");
		bootstrapTableSecurity(auth, "TokenType", true, false, "Tenant");
		bootstrapTableSecurity(auth, "UInt16Def", true, false, "Tenant");
		bootstrapTableSecurity(auth, "UInt16Type", true, false, "Tenant");
		bootstrapTableSecurity(auth, "UInt32Def", true, false, "Tenant");
		bootstrapTableSecurity(auth, "UInt32Type", true, false, "Tenant");
		bootstrapTableSecurity(auth, "UInt64Def", true, false, "Tenant");
		bootstrapTableSecurity(auth, "UInt64Type", true, false, "Tenant");
		bootstrapTableSecurity(auth, "UuidDef", true, false, "Tenant");
		bootstrapTableSecurity(auth, "Uuid6Def", true, false, "Tenant");
		bootstrapTableSecurity(auth, "UuidType", true, false, "Tenant");
		bootstrapTableSecurity(auth, "Uuid6Type", true, false, "Tenant");
		bootstrapTableSecurity(auth, "BlobCol", true, false, "Tenant");
		bootstrapTableSecurity(auth, "BoolCol", true, false, "Tenant");
		bootstrapTableSecurity(auth, "DateCol", true, false, "Tenant");
		bootstrapTableSecurity(auth, "DoubleCol", true, false, "Tenant");
		bootstrapTableSecurity(auth, "EnumDef", true, false, "Tenant");
		bootstrapTableSecurity(auth, "EnumType", true, false, "Tenant");
		bootstrapTableSecurity(auth, "FloatCol", true, false, "Tenant");
		bootstrapTableSecurity(auth, "Id16Gen", true, false, "Tenant");
		bootstrapTableSecurity(auth, "Id32Gen", true, false, "Tenant");
		bootstrapTableSecurity(auth, "Id64Gen", true, false, "Tenant");
		bootstrapTableSecurity(auth, "Int16Col", true, false, "Tenant");
		bootstrapTableSecurity(auth, "Int32Col", true, false, "Tenant");
		bootstrapTableSecurity(auth, "Int64Col", true, false, "Tenant");
		bootstrapTableSecurity(auth, "NmTokenCol", true, false, "Tenant");
		bootstrapTableSecurity(auth, "NmTokensCol", true, false, "Tenant");
		bootstrapTableSecurity(auth, "NumberCol", true, false, "Tenant");
		bootstrapTableSecurity(auth, "StringCol", true, false, "Tenant");
		bootstrapTableSecurity(auth, "TZDateCol", true, false, "Tenant");
		bootstrapTableSecurity(auth, "TZTimeCol", true, false, "Tenant");
		bootstrapTableSecurity(auth, "TZTimestampCol", true, false, "Tenant");
		bootstrapTableSecurity(auth, "TextCol", true, false, "Tenant");
		bootstrapTableSecurity(auth, "TimeCol", true, false, "Tenant");
		bootstrapTableSecurity(auth, "TimestampCol", true, false, "Tenant");
		bootstrapTableSecurity(auth, "TokenCol", true, false, "Tenant");
		bootstrapTableSecurity(auth, "UInt16Col", true, false, "Tenant");
		bootstrapTableSecurity(auth, "UInt32Col", true, false, "Tenant");
		bootstrapTableSecurity(auth, "UInt64Col", true, false, "Tenant");
		bootstrapTableSecurity(auth, "UuidCol", true, false, "Tenant");
		bootstrapTableSecurity(auth, "Uuid6Col", true, false, "Tenant");
		bootstrapTableSecurity(auth, "UuidGen", true, false, "Tenant");
		bootstrapTableSecurity(auth, "Uuid6Gen", true, false, "Tenant");
