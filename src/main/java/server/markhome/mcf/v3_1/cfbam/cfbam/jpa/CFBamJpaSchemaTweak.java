// Description: Java 25 JPA implementation of a SchemaTweak entity definition object.
...
@Entity
@Table(
	name = "schtwk", schema = "CFBam31",
	indexes = {
		@Index(name = "SchemaTweakIdIdx", columnList = "Id", unique = true),
		@Index(name = "SchemaTweakSchemaIdx", columnList = "SchemaDefId", unique = false),
		@Index(name = "SchemaTweakSchemaIdxSchemaDef", columnList = "SchemaDefIdSchemaDef", unique = false)
	}
)
...
public class CFBamJpaSchemaTweak extends CFBamJpaTweak
	implements ICFBamSchemaTweak
{
	...
	public void set( ICFBamTweak src ) {
		if( src instanceof ICFBamSchemaTweak ) {
			setSchemaTweak( (ICFBamSchemaTweak)src );
		}
		else {
	...
	public String toString() {
		String ret = "<CFBamJpaSchemaTweak" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
