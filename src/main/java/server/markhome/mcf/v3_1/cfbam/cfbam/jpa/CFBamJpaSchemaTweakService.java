...
public class CFBamJpaSchemaTweakService {
	...
	public CFBamJpaSchemaTweak create(CFBamJpaSchemaTweak data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31SchemaTweakRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaSchemaTweak)(cfbam31SchemaTweakRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaSchemaTweak update(CFBamJpaSchemaTweak data) {
		...
		CFBamJpaSchemaTweak existing = cfbam31SchemaTweakRepository.findById((ICFLibKeyHash256)(data.getPKey()))
