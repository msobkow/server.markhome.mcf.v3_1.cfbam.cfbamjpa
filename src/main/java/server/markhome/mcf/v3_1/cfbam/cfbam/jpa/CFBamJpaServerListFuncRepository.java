...
public interface CFBamJpaServerListFuncRepository extends JpaRepository<CFBamJpaServerListFunc, CFLibDbKeyHash256> {
	...
	List<CFBamJpaServerListFunc> findByMethCodeVisIdx(@Param("codeVis") ICFBamSchema.CodeVisibilityEnum requiredCodeVis);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaServerMethod r where r.requiredCodeVis = :codeVis")
	List<CFBamJpaServerListFunc> lockByMethCodeVisIdx(@Param("codeVis") ICFBamSchema.CodeVisibilityEnum requiredCodeVis);
