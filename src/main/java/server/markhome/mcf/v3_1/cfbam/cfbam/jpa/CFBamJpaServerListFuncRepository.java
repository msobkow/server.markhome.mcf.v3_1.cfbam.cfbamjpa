...
public interface CFBamJpaServerListFuncRepository extends JpaRepository<CFBamJpaServerListFunc, $implCommaIJavaOptAtomType$> {

	@Transactional
	@Modifying
	CFBamJpaServerListFunc save(CFBamJpaServerListFunc obj);
	...
	CFBamJpaServerListFunc get(@Param("id") ICFLibKeyHash256 requiredId);
	...
	List<CFBamJpaServerListFunc> findByTenantIdx(@Param("tenantId") ICFLibKeyHash256 requiredTenantId);
	...
	CFBamJpaServerListFunc findByUNameIdx(@Param("tableId") ICFLibKeyHash256 requiredTableId,
	...
	List<CFBamJpaServerListFunc> findByMethTableIdx(@Param("tableId") ICFLibKeyHash256 requiredTableId);
	...
	List<CFBamJpaServerListFunc> findByMethCodeVisIdx(@Param("codeVis") ICFBamPubSchema.CodeVisibilityEnum requiredCodeVis);
	 ...
	 *		@return The found entity list, which may be empty, typically populated from the JPA cache.
	 */
	default List<CFBamJpaServerListFunc> findByMethCodeVisIdx(ICFBamServerMethodByMethCodeVisIdxKey key) {
	...
	List<CFBamJpaServerListFunc> findByMethTableVisIdx(@Param("tableId") ICFLibKeyHash256 requiredTableId,
	 ...
	 *		@return The found entity list, which may be empty, typically populated from the JPA cache.
	 */
	default List<CFBamJpaServerListFunc> findByMethTableVisIdx(ICFBamServerMethodByMethTableVisIdxKey key) {
	...
	List<CFBamJpaServerListFunc> findByDefSchemaIdx(@Param("defSchemaId") ICFLibKeyHash256 optionalDefSchemaId);
	...
	List<CFBamJpaServerListFunc> findByRetTblIdx(@Param("retTableId") ICFLibKeyHash256 optionalRetTableId);
	...
	@Query("select r from CFBamJpaScope r where r.requiredId = :id")
	CFBamJpaServerListFunc lockByIdIdx(@Param("id") ICFLibKeyHash256 requiredId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaScope r where r.requiredTenantId = :tenantId")
	List<CFBamJpaServerListFunc> lockByTenantIdx(@Param("tenantId") ICFLibKeyHash256 requiredTenantId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaServerMethod r where r.requiredContainerForTable.requiredId = :tableId and r.requiredName = :name")
	CFBamJpaServerListFunc lockByUNameIdx(@Param("tableId") ICFLibKeyHash256 requiredTableId,
		@Param("name") String requiredName);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaServerMethod r where r.requiredContainerForTable.requiredId = :tableId")
	List<CFBamJpaServerListFunc> lockByMethTableIdx(@Param("tableId") ICFLibKeyHash256 requiredTableId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaServerMethod r where r.requiredCodeVis = :codeVis")
	List<CFBamJpaServerListFunc> lockByMethCodeVisIdx(@Param("codeVis") ICFBamPubSchema.CodeVisibilityEnum requiredCodeVis);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaServerListFunc> lockByMethCodeVisIdx(ICFBamServerMethodByMethCodeVisIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaServerMethod r where r.requiredContainerForTable.requiredId = :tableId and r.requiredCodeVis = :codeVis")
	List<CFBamJpaServerListFunc> lockByMethTableVisIdx(@Param("tableId") ICFLibKeyHash256 requiredTableId,
		@Param("codeVis") ICFBamPubSchema.CodeVisibilityEnum requiredCodeVis);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaServerListFunc> lockByMethTableVisIdx(ICFBamServerMethodByMethTableVisIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaServerMethod r where r.optionalLookupDefSchema.requiredId = :defSchemaId")
	List<CFBamJpaServerListFunc> lockByDefSchemaIdx(@Param("defSchemaId") ICFLibKeyHash256 optionalDefSchemaId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaServerListFunc r where r.optionalLookupRetTable.requiredId = :retTableId")
	List<CFBamJpaServerListFunc> lockByRetTblIdx(@Param("retTableId") ICFLibKeyHash256 optionalRetTableId);
