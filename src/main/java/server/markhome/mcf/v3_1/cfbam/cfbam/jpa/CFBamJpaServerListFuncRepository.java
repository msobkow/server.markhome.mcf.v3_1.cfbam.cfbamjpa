...
public interface CFBamJpaServerListFuncRepository extends JpaRepository<CFBamJpaServerListFunc, CFLibDbKeyHash256> {
	...
	List<CFBamJpaServerListFunc> findByMethTableVisIdx(@Param("tableId") CFLibDbKeyHash256 requiredTableId,
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaServerMethod r where r.requiredContainerForTable.requiredId = :tableId and r.requiredCodeVis = :codeVis")
	List<CFBamJpaServerListFunc> lockByMethTableVisIdx(@Param("tableId") CFLibDbKeyHash256 requiredTableId,
		@Param("codeVis") ICFBamPubSchema.CodeVisibilityEnum requiredCodeVis);
