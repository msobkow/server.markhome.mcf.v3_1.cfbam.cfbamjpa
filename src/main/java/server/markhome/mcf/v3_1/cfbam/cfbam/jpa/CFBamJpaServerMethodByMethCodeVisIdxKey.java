// Description: Java 25 JPA implementation of a ServerMethod by MethCodeVisIdx index key object.
...
public class CFBamJpaServerMethodByMethCodeVisIdxKey
	implements ICFBamServerMethodByMethCodeVisIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamServerMethodByMethCodeVisIdxKey, ICFBamServerMethod$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamServerMethodByMethCodeVisIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
