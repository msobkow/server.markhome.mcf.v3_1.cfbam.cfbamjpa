...
// Description: Java 25 Factory service implementation for ServerObjFunc JPA objects
...
/*
 *	Java 25 Factory service implementation for ServerObjFunc JPA objects.
 */
public class CFBamJpaServerObjFuncFactoryService
    implements ICFBamServerObjFuncFactory
{
    public CFBamJpaServerObjFuncFactoryService() { }

    @Override
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
    public ICFBamServerObjFuncByRetTblIdxKey newByRetTblIdxKey() {
		ICFBamServerObjFuncByRetTblIdxKey key = new CFBamJpaServerObjFuncByRetTblIdxKey();
	return( key );
    }
    ...
    public ICFBamServerObjFunc newRec() {
        ICFBamServerObjFunc rec = new CFBamJpaServerObjFunc();
        return( rec );
    }
    ...
    public ICFBamServerObjFuncH newHRec() {
        ICFBamServerObjFuncH hrec = new CFBamJpaServerObjFuncH();
        return( hrec );
    }
