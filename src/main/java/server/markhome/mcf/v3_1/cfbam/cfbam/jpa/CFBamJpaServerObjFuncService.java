...
public class CFBamJpaServerObjFuncService {
	...
	public CFBamJpaServerObjFunc create(CFBamJpaServerObjFunc data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31ServerObjFuncRepository.existsById(($implCommaIJavaOptAtomType$)data.getPKey())) {
				return( (CFBamJpaServerObjFunc)(cfbam31ServerObjFuncRepository.findById(($implCommaIJavaOptAtomType$)(data.getPKey())).get()));
			}
	...
	public CFBamJpaServerObjFunc update(CFBamJpaServerObjFunc data) {
		...
		CFBamJpaServerObjFunc existing = cfbam31ServerObjFuncRepository.findById(($implCommaIJavaOptAtomType$)(data.getPKey()))
	...
	public CFBamJpaServerObjFunc find(@Param("id") ICFLibKeyHash256 requiredId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaServerObjFunc> findByTenantIdx(@Param("tenantId") ICFLibKeyHash256 requiredTenantId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public CFBamJpaServerObjFunc findByUNameIdx(@Param("tableId") ICFLibKeyHash256 requiredTableId,
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaServerObjFunc> findByMethTableIdx(@Param("tableId") ICFLibKeyHash256 requiredTableId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaServerObjFunc> findByMethCodeVisIdx(@Param("codeVis") ICFBamPubSchema.CodeVisibilityEnum requiredCodeVis) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaServerObjFunc> findByMethTableVisIdx(@Param("tableId") ICFLibKeyHash256 requiredTableId,
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaServerObjFunc> findByDefSchemaIdx(@Param("defSchemaId") ICFLibKeyHash256 optionalDefSchemaId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaServerObjFunc> findByRetTblIdx(@Param("retTableId") ICFLibKeyHash256 optionalRetTableId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public CFBamJpaServerObjFunc lockByIdIdx(@Param("id") ICFLibKeyHash256 requiredId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaServerObjFunc> lockByTenantIdx(@Param("tenantId") ICFLibKeyHash256 requiredTenantId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public CFBamJpaServerObjFunc lockByUNameIdx(@Param("tableId") ICFLibKeyHash256 requiredTableId,
		@Param("name") String requiredName) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaServerObjFunc> lockByMethTableIdx(@Param("tableId") ICFLibKeyHash256 requiredTableId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaServerObjFunc> lockByMethCodeVisIdx(@Param("codeVis") ICFBamPubSchema.CodeVisibilityEnum requiredCodeVis) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaServerObjFunc> lockByMethTableVisIdx(@Param("tableId") ICFLibKeyHash256 requiredTableId,
		@Param("codeVis") ICFBamPubSchema.CodeVisibilityEnum requiredCodeVis) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaServerObjFunc> lockByDefSchemaIdx(@Param("defSchemaId") ICFLibKeyHash256 optionalDefSchemaId) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaServerObjFunc> lockByRetTblIdx(@Param("retTableId") ICFLibKeyHash256 optionalRetTableId) {
