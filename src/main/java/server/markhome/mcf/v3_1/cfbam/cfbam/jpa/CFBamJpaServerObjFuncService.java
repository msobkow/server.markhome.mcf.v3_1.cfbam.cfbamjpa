...
public class CFBamJpaServerObjFuncService {
	...
	public CFBamJpaServerObjFunc create(CFBamJpaServerObjFunc data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31ServerObjFuncRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaServerObjFunc)(cfbam31ServerObjFuncRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaServerObjFunc update(CFBamJpaServerObjFunc data) {
		...
		CFBamJpaServerObjFunc existing = cfbam31ServerObjFuncRepository.findById((ICFLibKeyHash256)(data.getPKey()))
