...
// Description: Java 25 Factory service implementation for ServerProc JPA objects
...
/*
 *	Java 25 Factory service implementation for ServerProc JPA objects.
 */
public class CFBamJpaServerProcFactoryService
    implements ICFBamServerProcFactory
{
    ...
    public ICFBamServerProcH newHRec() {
        ICFBamServerProcH hrec = new CFBamJpaServerProcH();
        return( hrec );
    }
