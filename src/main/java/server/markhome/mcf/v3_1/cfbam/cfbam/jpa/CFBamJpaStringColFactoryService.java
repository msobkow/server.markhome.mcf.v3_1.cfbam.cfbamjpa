...
// Description: Java 25 Factory service implementation for StringCol JPA objects
...
/*
 *	Java 25 Factory service implementation for StringCol JPA objects.
 */
public class CFBamJpaStringColFactoryService
    implements ICFBamStringColFactory
{
    public CFBamJpaStringColFactoryService() { }

    @Override
    public ICFBamStringColByTableIdxKey newByTableIdxKey() {
		ICFBamStringColByTableIdxKey key = new CFBamJpaStringColByTableIdxKey();
	return( key );
    }
    ...
    public ICFBamStringCol newRec() {
        ICFBamStringCol rec = new CFBamJpaStringCol();
        return( rec );
    }
    ...
    public ICFBamStringColH newHRec() {
        ICFBamStringColH hrec = new CFBamJpaStringColH();
        return( hrec );
    }
