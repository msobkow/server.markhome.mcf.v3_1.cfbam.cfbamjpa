...
/**
 *	JpaRepository for the CFBamJpaStringCol entities defined in server.markhome.mcf.v3_1.cfbam.cfbam.jpa.
 *	The manufactured repositories try to provide a rich, do-it-all interface to the JPA data store, with both object and argument-based implementations of the interface defined.
 */
@Transactional(readOnly = true)
public interface CFBamJpaStringColRepository extends JpaRepository<CFBamJpaStringCol, $implCommaIJavaOptAtomType$> {

	@Transactional
	@Modifying
	CFBamJpaStringCol save(CFBamJpaStringCol obj);
	...
	CFBamJpaStringCol get(@Param("id") ICFLibKeyHash256 requiredId);
	...
	CFBamJpaStringCol findByUNameIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
	...
	List<CFBamJpaStringCol> findByScopeIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId);
	...
	List<CFBamJpaStringCol> findByDefSchemaIdx(@Param("defSchemaId") ICFLibKeyHash256 optionalDefSchemaId);
	...
	List<CFBamJpaStringCol> findByPrevIdx(@Param("prevId") ICFLibKeyHash256 optionalPrevId);
	...
	List<CFBamJpaStringCol> findByNextIdx(@Param("nextId") ICFLibKeyHash256 optionalNextId);
	...
	List<CFBamJpaStringCol> findByContPrevIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
	...
	List<CFBamJpaStringCol> findByContNextIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
	 ...
	 *		@return List&lt;CFBamJpaStringCol&gt; of the found entities, typically from the JPA cache, or an empty list if no such entities exist.
	 */
	@Query("select r from CFBamJpaStringCol r where r.requiredContainerTable.requiredId = :tableId")
	List<CFBamJpaStringCol> findByTableIdx(@Param("tableId") ICFLibKeyHash256 requiredTableId);
	...
	@Query("select r from CFBamJpaValue r where r.requiredId = :id")
	CFBamJpaStringCol lockByIdIdx(@Param("id") ICFLibKeyHash256 requiredId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredContainerScope.requiredId = :scopeId and r.requiredName = :name")
	CFBamJpaStringCol lockByUNameIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
		@Param("name") String requiredName);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredContainerScope.requiredId = :scopeId")
	List<CFBamJpaStringCol> lockByScopeIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.optionalLookupDefSchema.requiredId = :defSchemaId")
	List<CFBamJpaStringCol> lockByDefSchemaIdx(@Param("defSchemaId") ICFLibKeyHash256 optionalDefSchemaId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.optionalLookupPrev.requiredId = :prevId")
	List<CFBamJpaStringCol> lockByPrevIdx(@Param("prevId") ICFLibKeyHash256 optionalPrevId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.optionalLookupNext.requiredId = :nextId")
	List<CFBamJpaStringCol> lockByNextIdx(@Param("nextId") ICFLibKeyHash256 optionalNextId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredContainerScope.requiredId = :scopeId and r.optionalLookupPrev.requiredId = :prevId")
	List<CFBamJpaStringCol> lockByContPrevIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
		@Param("prevId") ICFLibKeyHash256 optionalPrevId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredContainerScope.requiredId = :scopeId and r.optionalLookupNext.requiredId = :nextId")
	List<CFBamJpaStringCol> lockByContNextIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
		@Param("nextId") ICFLibKeyHash256 optionalNextId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaStringCol r where r.requiredContainerTable.requiredId = :tableId")
	List<CFBamJpaStringCol> lockByTableIdx(@Param("tableId") ICFLibKeyHash256 requiredTableId);
	...
	@Transactional
	@Modifying
	@Query("delete from CFBamJpaStringCol r where r.requiredContainerTable.requiredId = :tableId")
