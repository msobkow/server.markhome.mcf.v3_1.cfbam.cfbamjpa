...
// Description: Java 25 Factory service implementation for StringDef JPA objects
...
/*
 *	Java 25 Factory service implementation for StringDef JPA objects.
 */
public class CFBamJpaStringDefFactoryService
    implements ICFBamStringDefFactory
{
    public CFBamJpaStringDefFactoryService() { }

    @Override
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
    public ICFBamStringDef newRec() {
        ICFBamStringDef rec = new CFBamJpaStringDef();
        return( rec );
    }
    ...
    public ICFBamStringDefH newHRec() {
        ICFBamStringDefH hrec = new CFBamJpaStringDefH();
        return( hrec );
    }
