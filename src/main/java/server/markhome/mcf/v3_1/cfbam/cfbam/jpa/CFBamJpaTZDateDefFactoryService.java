...
// Description: Java 25 Factory service implementation for TZDateDef JPA objects
...
/*
 *	Java 25 Factory service implementation for TZDateDef JPA objects.
 */
public class CFBamJpaTZDateDefFactoryService
    implements ICFBamTZDateDefFactory
{
    public CFBamJpaTZDateDefFactoryService() { }

    @Override
    public ICFBamTZDateDef newRec() {
        ICFBamTZDateDef rec = new CFBamJpaTZDateDef();
        return( rec );
    }
    ...
    public ICFBamTZDateDefH newHRec() {
        ICFBamTZDateDefH hrec = new CFBamJpaTZDateDefH();
        return( hrec );
    }
