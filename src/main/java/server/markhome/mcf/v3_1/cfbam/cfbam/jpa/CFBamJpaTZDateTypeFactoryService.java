...
// Description: Java 25 Factory service implementation for TZDateType JPA objects
...
/*
 *	Java 25 Factory service implementation for TZDateType JPA objects.
 */
public class CFBamJpaTZDateTypeFactoryService
    implements ICFBamTZDateTypeFactory
{
    public CFBamJpaTZDateTypeFactoryService() { }

    @Override
    public ICFBamTZDateTypeBySchemaIdxKey newBySchemaIdxKey() {
		ICFBamTZDateTypeBySchemaIdxKey key = new CFBamJpaTZDateTypeBySchemaIdxKey();
	return( key );
    }
    ...
    public ICFBamTZDateType newRec() {
        ICFBamTZDateType rec = new CFBamJpaTZDateType();
        return( rec );
    }
    ...
    public ICFBamTZDateTypeH newHRec() {
        ICFBamTZDateTypeH hrec = new CFBamJpaTZDateTypeH();
        return( hrec );
    }
