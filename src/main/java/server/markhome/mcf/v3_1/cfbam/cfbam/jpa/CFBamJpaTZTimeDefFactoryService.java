...
// Description: Java 25 Factory service implementation for TZTimeDef JPA objects
...
/*
 *	Java 25 Factory service implementation for TZTimeDef JPA objects.
 */
public class CFBamJpaTZTimeDefFactoryService
    implements ICFBamTZTimeDefFactory
{
    public CFBamJpaTZTimeDefFactoryService() { }

    @Override
    public ICFBamTZTimeDef newRec() {
        ICFBamTZTimeDef rec = new CFBamJpaTZTimeDef();
        return( rec );
    }
    ...
    public ICFBamTZTimeDefH newHRec() {
        ICFBamTZTimeDefH hrec = new CFBamJpaTZTimeDefH();
        return( hrec );
    }
