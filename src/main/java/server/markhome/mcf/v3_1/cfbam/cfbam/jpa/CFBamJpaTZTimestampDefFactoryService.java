...
// Description: Java 25 Factory service implementation for TZTimestampDef JPA objects
...
/*
 *	Java 25 Factory service implementation for TZTimestampDef JPA objects.
 */
public class CFBamJpaTZTimestampDefFactoryService
    implements ICFBamTZTimestampDefFactory
{
    ...
    public ICFBamTZTimestampDefH newHRec() {
        ICFBamTZTimestampDefH hrec = new CFBamJpaTZTimestampDefH();
        return( hrec );
    }
