...
// Description: Java 25 Factory service implementation for TZTimestampType JPA objects
...
/*
 *	Java 25 Factory service implementation for TZTimestampType JPA objects.
 */
public class CFBamJpaTZTimestampTypeFactoryService
    implements ICFBamTZTimestampTypeFactory
{
    ...
    public ICFBamTZTimestampTypeH newHRec() {
        ICFBamTZTimestampTypeH hrec = new CFBamJpaTZTimestampTypeH();
        return( hrec );
    }
