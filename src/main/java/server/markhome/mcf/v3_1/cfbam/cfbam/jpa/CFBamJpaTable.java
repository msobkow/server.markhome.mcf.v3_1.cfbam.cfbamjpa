...
@Table(
	...
	indexes = {
		...
		@Index(name = "TableCodeVisIdx", columnList = "codevis", unique = false),
		@Index(name = "TableSchemaCodeVisIdx", columnList = "SchemaDefId, codevis", unique = false),
	...
	implements ICFBamTable
{
	...
	protected Set<CFBamJpaValue> optionalComponentsColumns;
	...
	public void setRequiredContainerSchemaDef(CFLibDbKeyHash256 argSchemaDefId) {
		...
		ICFBamSchemaDef targetRec = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argSchemaDefId);
	...
	public void setOptionalLookupLookupIndex(ICFBamIndex argObj) {
		if(argObj == null) {
			...
			if (optionalLookupLookupIndex != null) {
				optionalLookupIndexId = optionalLookupLookupIndex.getRequiredId();
			}
			else {
	...
	public void setOptionalLookupLookupIndex(CFLibDbKeyHash256 argLookupIndexId) {
		...
		ICFBamIndex targetRec = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argLookupIndexId);
	...
	public void setOptionalLookupAltIndex(ICFBamIndex argObj) {
		if(argObj == null) {
			...
			if (optionalLookupAltIndex != null) {
				optionalAltIndexId = optionalLookupAltIndex.getRequiredId();
			}
			else {
	...
	public void setOptionalLookupAltIndex(CFLibDbKeyHash256 argAltIndexId) {
		...
		ICFBamIndex targetRec = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argAltIndexId);
	...
	public void setOptionalLookupQualTable(ICFBamTable argObj) {
		if(argObj == null) {
			...
			if (optionalLookupQualTable != null) {
				optionalQualifyingTableId = optionalLookupQualTable.getRequiredId();
			}
			else {
	...
	public void setOptionalLookupQualTable(CFLibDbKeyHash256 argQualifyingTableId) {
		...
		ICFBamTable targetRec = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argQualifyingTableId);
	...
	public void setOptionalLookupPrimaryIndex(ICFBamIndex argObj) {
		if(argObj == null) {
			...
			if (optionalLookupPrimaryIndex != null) {
				optionalPrimaryIndexId = optionalLookupPrimaryIndex.getRequiredId();
			}
			else {
	...
	public void setOptionalLookupPrimaryIndex(CFLibDbKeyHash256 argPrimaryIndexId) {
		...
		ICFBamIndex targetRec = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argPrimaryIndexId);
		setOptionalLookupPrimaryIndex(targetRec);
	}

	@Override
	public List<ICFBamRelation> getOptionalComponentsRelation() {
		List<ICFBamRelation> retlist = (optionalComponentsRelation != null) ? new ArrayList<>(optionalComponentsRelation) : new ArrayList<>();
		return( retlist );
	}

	@Override
	public List<ICFBamIndex> getOptionalComponentsIndex() {
		List<ICFBamIndex> retlist = (optionalComponentsIndex != null) ? new ArrayList<>(optionalComponentsIndex) : new ArrayList<>();
		return( retlist );
	}

	@Override
	public List<ICFBamValue> getOptionalComponentsColumns() {
		List<ICFBamValue> retlist = (optionalComponentsColumns != null) ? new ArrayList<>(optionalComponentsColumns) : new ArrayList<>();
		return( retlist );
	}

	@Override
	public List<ICFBamRelation> getOptionalChildrenReverseRelations() {
		List<ICFBamRelation> retlist = (optionalChildrenReverseRelations != null) ? new ArrayList<>(optionalChildrenReverseRelations) : new ArrayList<>();
		return( retlist );
	}

	@Override
	public List<ICFBamChain> getOptionalComponentsChains() {
		List<ICFBamChain> retlist = (optionalComponentsChains != null) ? new ArrayList<>(optionalComponentsChains) : new ArrayList<>();
		return( retlist );
	}

	@Override
	public List<ICFBamDelTopDep> getOptionalComponentsDelDep() {
		List<ICFBamDelTopDep> retlist = (optionalComponentsDelDep != null) ? new ArrayList<>(optionalComponentsDelDep) : new ArrayList<>();
		return( retlist );
	}

	@Override
	public List<ICFBamClearTopDep> getOptionalComponentsClearDep() {
		List<ICFBamClearTopDep> retlist = (optionalComponentsClearDep != null) ? new ArrayList<>(optionalComponentsClearDep) : new ArrayList<>();
		return( retlist );
	}

	@Override
	public List<ICFBamServerMethod> getOptionalComponentsServerMethods() {
		List<ICFBamServerMethod> retlist = (optionalComponentsServerMethods != null) ? new ArrayList<>(optionalComponentsServerMethods) : new ArrayList<>();
		return( retlist );
	}

	@Override
	public List<ICFBamTweak> getOptionalComponentsTweaks() {
		List<ICFBamTweak> retlist = (optionalComponentsTweaks != null) ? new ArrayList<>(optionalComponentsTweaks) : new ArrayList<>();
		return( retlist );
	}
