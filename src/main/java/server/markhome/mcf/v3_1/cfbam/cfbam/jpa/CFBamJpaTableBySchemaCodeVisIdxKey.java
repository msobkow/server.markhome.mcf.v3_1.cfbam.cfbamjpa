// Description: Java 25 JPA implementation of a Table by SchemaCodeVisIdx index key object.
	...
	implements ICFBamTableBySchemaCodeVisIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamTableBySchemaCodeVisIdxKey, ICFBamTable$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamTableBySchemaCodeVisIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
