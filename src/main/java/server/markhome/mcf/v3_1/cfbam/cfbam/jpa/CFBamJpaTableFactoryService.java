...
// Description: Java 25 Factory service implementation for Table JPA objects
...
/*
 *	Java 25 Factory service implementation for Table JPA objects.
 */
public class CFBamJpaTableFactoryService
    implements ICFBamTableFactory
{
    ...
    public ICFBamTableH newHRec() {
        ICFBamTableH hrec = new CFBamJpaTableH();
        return( hrec );
    }
