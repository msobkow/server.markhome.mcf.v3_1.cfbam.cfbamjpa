...
public class CFBamJpaTableService {
	...
	public CFBamJpaTable create(CFBamJpaTable data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31TableRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaTable)(cfbam31TableRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaTable update(CFBamJpaTable data) {
		...
		CFBamJpaTable existing = cfbam31TableRepository.findById((ICFLibKeyHash256)(data.getPKey()))
