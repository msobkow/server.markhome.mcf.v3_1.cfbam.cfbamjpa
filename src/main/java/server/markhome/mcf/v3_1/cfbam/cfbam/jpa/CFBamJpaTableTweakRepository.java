// Description: Java 25 Spring JPA Repository for TableTweak
...
/**
 *	JpaRepository for the CFBamJpaTableTweak entities defined in server.markhome.mcf.v3_1.cfbam.cfbam.jpa.
 *	The manufactured repositories try to provide a rich, do-it-all interface to the JPA data store, with both object and argument-based implementations of the interface defined.
 */
@Transactional(readOnly = true)
public interface CFBamJpaTableTweakRepository extends JpaRepository<CFBamJpaTableTweak, $implCommaIJavaOptAtomType$> {

	@Transactional
	@Modifying
	CFBamJpaTableTweak save(CFBamJpaTableTweak obj);
	...
	CFBamJpaTableTweak get(@Param("id") ICFLibKeyHash256 requiredId);
	...
	CFBamJpaTableTweak findByUNameIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
	 ...
	 *		@return The found entity, typically from the JPA cache, or null if no such entity exists.
	 */
	default CFBamJpaTableTweak findByUNameIdx(ICFBamTweakByUNameIdxKey key) {
	 ...
	 *
	 *		@return List&lt;CFBamJpaTableTweak&gt; of the found entities, typically from the JPA cache, or an empty list if no such entities exist.
	 */
	@Query("select r from CFBamJpaTweak r where r.requiredTenantId = :tenantId")
	List<CFBamJpaTableTweak> findByValTentIdx(@Param("tenantId") ICFLibKeyHash256 requiredTenantId);
	 ...
	 */
	default List<CFBamJpaTableTweak> findByValTentIdx(ICFBamTweakByValTentIdxKey key) {
	...
	List<CFBamJpaTableTweak> findByScopeIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId);
	 ...
	 *		@return The found entity list, which may be empty, typically populated from the JPA cache.
	 */
	default List<CFBamJpaTableTweak> findByScopeIdx(ICFBamTweakByScopeIdxKey key) {
	...
	List<CFBamJpaTableTweak> findByDefSchemaIdx(@Param("defSchemaId") ICFLibKeyHash256 optionalDefSchemaId);
	 ...
	 *		@return The found entity list, which may be empty, typically populated from the JPA cache.
	 */
	default List<CFBamJpaTableTweak> findByDefSchemaIdx(ICFBamTweakByDefSchemaIdxKey key) {
	...
	CFBamJpaTableTweak findByUDefIdx(@Param("tenantId") ICFLibKeyHash256 requiredTenantId,
	 ...
	 *		@return The found entity, typically from the JPA cache, or null if no such entity exists.
	 */
	default CFBamJpaTableTweak findByUDefIdx(ICFBamTweakByUDefIdxKey key) {
	...
	// CFBamJpaTableTweak specified index readers

	/**
	 *	Read zero or more entities into a List using the columns of the CFBamTableTweakByTableIdxKey as arguments.
	 *
	 *		@param requiredTableId
	 *
	 *		@return List&lt;CFBamJpaTableTweak&gt; of the found entities, typically from the JPA cache, or an empty list if no such entities exist.
	 */
	@Query("select r from CFBamJpaTableTweak r where r.requiredContainerTableDef.requiredId = :tableId")
	List<CFBamJpaTableTweak> findByTableIdx(@Param("tableId") ICFLibKeyHash256 requiredTableId);

	/**
	 *	CFBamTableTweakByTableIdxKey entity list reader convenience method for object-based access.
	 *
	 *		@param key The CFBamTableTweakByTableIdxKey instance to use for the query arguments.
	 *
	 *		@return The found entity list, which may be empty, typically populated from the JPA cache.
	 */
	default List<CFBamJpaTableTweak> findByTableIdx(ICFBamTableTweakByTableIdxKey key) {
	...
	@Query("select r from CFBamJpaTweak r where r.requiredId = :id")
	CFBamJpaTableTweak lockByIdIdx(@Param("id") ICFLibKeyHash256 requiredId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaTweak r where r.requiredContainerScopeDef.requiredId = :scopeId and r.requiredName = :name")
	CFBamJpaTableTweak lockByUNameIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
		@Param("name") String requiredName);
	 ...
	 *		@return The locked entity, refreshed from the data store, or null if no such entity exists.
	 */
	default CFBamJpaTableTweak lockByUNameIdx(ICFBamTweakByUNameIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaTweak r where r.requiredTenantId = :tenantId")
	List<CFBamJpaTableTweak> lockByValTentIdx(@Param("tenantId") ICFLibKeyHash256 requiredTenantId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaTableTweak> lockByValTentIdx(ICFBamTweakByValTentIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaTweak r where r.requiredContainerScopeDef.requiredId = :scopeId")
	List<CFBamJpaTableTweak> lockByScopeIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaTableTweak> lockByScopeIdx(ICFBamTweakByScopeIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaTweak r where r.optionalLookupDefSchema.requiredId = :defSchemaId")
	List<CFBamJpaTableTweak> lockByDefSchemaIdx(@Param("defSchemaId") ICFLibKeyHash256 optionalDefSchemaId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaTableTweak> lockByDefSchemaIdx(ICFBamTweakByDefSchemaIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaTweak r where r.requiredTenantId = :tenantId and r.requiredContainerScopeDef.requiredId = :scopeId and r.optionalDefSchemaTenantId = :defSchemaTenantId and r.optionalLookupDefSchema.requiredId = :defSchemaId and r.requiredName = :name")
	CFBamJpaTableTweak lockByUDefIdx(@Param("tenantId") ICFLibKeyHash256 requiredTenantId,
		@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
		@Param("defSchemaTenantId") ICFLibKeyHash256 optionalDefSchemaTenantId,
		@Param("defSchemaId") ICFLibKeyHash256 optionalDefSchemaId,
		@Param("name") String requiredName);
	 ...
	 *		@return The locked entity, refreshed from the data store, or null if no such entity exists.
	 */
	default CFBamJpaTableTweak lockByUDefIdx(ICFBamTweakByUDefIdxKey key) {
	...
	// CFBamJpaTableTweak specified delete-by-index methods
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaTableTweak r where r.requiredContainerTableDef.requiredId = :tableId")
	List<CFBamJpaTableTweak> lockByTableIdx(@Param("tableId") ICFLibKeyHash256 requiredTableId);

	/**
	 *	CFBamTableTweakByTableIdxKey based lock method for object-based access.
	 *
	 *		@param key The key of the entity to be locked.
	 *
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaTableTweak> lockByTableIdx(ICFBamTableTweakByTableIdxKey key) {
	...
	@Transactional
	@Modifying
	@Query("delete from CFBamJpaTableTweak r where r.requiredContainerTableDef.requiredId = :tableId")
	void deleteByTableIdx(@Param("tableId") ICFLibKeyHash256 requiredTableId);

	/**
	 *	CFBamTableTweakByTableIdxKey based lock method for object-based access.
	 *
	 *		@param key The CFBamTableTweakByTableIdxKey of the entity to be locked.
	 */
	default void deleteByTableIdx(ICFBamTableTweakByTableIdxKey key) {
