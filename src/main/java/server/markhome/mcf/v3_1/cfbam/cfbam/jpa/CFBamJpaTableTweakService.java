...
public class CFBamJpaTableTweakService {
	...
	public CFBamJpaTableTweak create(CFBamJpaTableTweak data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31TableTweakRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaTableTweak)(cfbam31TableTweakRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaTableTweak update(CFBamJpaTableTweak data) {
		...
		CFBamJpaTableTweak existing = cfbam31TableTweakRepository.findById((ICFLibKeyHash256)(data.getPKey()))
