...
// Description: Java 25 Factory service implementation for TextCol JPA objects
...
/*
 *	Java 25 Factory service implementation for TextCol JPA objects.
 */
public class CFBamJpaTextColFactoryService
    implements ICFBamTextColFactory
{
    public CFBamJpaTextColFactoryService() { }

    @Override
    public ICFBamTextColByTableIdxKey newByTableIdxKey() {
		ICFBamTextColByTableIdxKey key = new CFBamJpaTextColByTableIdxKey();
	return( key );
    }
    ...
    public ICFBamTextCol newRec() {
        ICFBamTextCol rec = new CFBamJpaTextCol();
        return( rec );
    }
    ...
    public ICFBamTextColH newHRec() {
        ICFBamTextColH hrec = new CFBamJpaTextColH();
        return( hrec );
    }
