...
// Description: Java 25 Factory service implementation for TextDef JPA objects
...
/*
 *	Java 25 Factory service implementation for TextDef JPA objects.
 */
public class CFBamJpaTextDefFactoryService
    implements ICFBamTextDefFactory
{
    ...
    public ICFBamTextDefH newHRec() {
        ICFBamTextDefH hrec = new CFBamJpaTextDefH();
        return( hrec );
    }
