...
// Description: Java 25 Factory service implementation for TimeCol JPA objects
...
/*
 *	Java 25 Factory service implementation for TimeCol JPA objects.
 */
public class CFBamJpaTimeColFactoryService
    implements ICFBamTimeColFactory
{
    public CFBamJpaTimeColFactoryService() { }

    @Override
    public ICFBamTimeColByTableIdxKey newByTableIdxKey() {
		ICFBamTimeColByTableIdxKey key = new CFBamJpaTimeColByTableIdxKey();
	return( key );
    }
    ...
    public ICFBamTimeCol newRec() {
        ICFBamTimeCol rec = new CFBamJpaTimeCol();
        return( rec );
    }
    ...
    public ICFBamTimeColH newHRec() {
        ICFBamTimeColH hrec = new CFBamJpaTimeColH();
        return( hrec );
    }
