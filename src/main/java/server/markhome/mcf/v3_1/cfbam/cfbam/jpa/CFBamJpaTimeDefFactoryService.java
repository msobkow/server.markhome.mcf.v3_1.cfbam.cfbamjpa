...
// Description: Java 25 Factory service implementation for TimeDef JPA objects
...
/*
 *	Java 25 Factory service implementation for TimeDef JPA objects.
 */
public class CFBamJpaTimeDefFactoryService
    implements ICFBamTimeDefFactory
{
    public CFBamJpaTimeDefFactoryService() { }

    @Override
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
    public ICFBamTimeDef newRec() {
        ICFBamTimeDef rec = new CFBamJpaTimeDef();
        return( rec );
    }
    ...
    public ICFBamTimeDefH newHRec() {
        ICFBamTimeDefH hrec = new CFBamJpaTimeDefH();
        return( hrec );
    }
