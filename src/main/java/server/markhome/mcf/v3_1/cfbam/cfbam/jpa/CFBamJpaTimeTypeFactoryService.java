...
// Description: Java 25 Factory service implementation for TimeType JPA objects
...
/*
 *	Java 25 Factory service implementation for TimeType JPA objects.
 */
public class CFBamJpaTimeTypeFactoryService
    implements ICFBamTimeTypeFactory
{
    public CFBamJpaTimeTypeFactoryService() { }

    @Override
    public ICFBamTimeTypeBySchemaIdxKey newBySchemaIdxKey() {
		ICFBamTimeTypeBySchemaIdxKey key = new CFBamJpaTimeTypeBySchemaIdxKey();
	return( key );
    }
    ...
    public ICFBamTimeType newRec() {
        ICFBamTimeType rec = new CFBamJpaTimeType();
        return( rec );
    }
    ...
    public ICFBamTimeTypeH newHRec() {
        ICFBamTimeTypeH hrec = new CFBamJpaTimeTypeH();
        return( hrec );
    }
