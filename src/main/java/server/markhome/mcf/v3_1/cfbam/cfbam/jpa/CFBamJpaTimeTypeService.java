...
public class CFBamJpaTimeTypeService {
	...
	public CFBamJpaTimeType create(CFBamJpaTimeType data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31TimeTypeRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaTimeType)(cfbam31TimeTypeRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaTimeType update(CFBamJpaTimeType data) {
		...
		CFBamJpaTimeType existing = cfbam31TimeTypeRepository.findById((ICFLibKeyHash256)(data.getPKey()))
