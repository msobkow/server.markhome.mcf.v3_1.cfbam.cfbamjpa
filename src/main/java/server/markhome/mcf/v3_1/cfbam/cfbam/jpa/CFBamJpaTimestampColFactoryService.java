...
// Description: Java 25 Factory service implementation for TimestampCol JPA objects
...
/*
 *	Java 25 Factory service implementation for TimestampCol JPA objects.
 */
public class CFBamJpaTimestampColFactoryService
    implements ICFBamTimestampColFactory
{
    public CFBamJpaTimestampColFactoryService() { }

    @Override
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
    public ICFBamTimestampColByTableIdxKey newByTableIdxKey() {
		ICFBamTimestampColByTableIdxKey key = new CFBamJpaTimestampColByTableIdxKey();
	return( key );
    }
    ...
    public ICFBamTimestampCol newRec() {
        ICFBamTimestampCol rec = new CFBamJpaTimestampCol();
        return( rec );
    }
    ...
    public ICFBamTimestampColH newHRec() {
        ICFBamTimestampColH hrec = new CFBamJpaTimestampColH();
        return( hrec );
    }
