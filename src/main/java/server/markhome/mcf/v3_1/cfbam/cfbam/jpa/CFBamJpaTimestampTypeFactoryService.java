...
// Description: Java 25 Factory service implementation for TimestampType JPA objects
...
/*
 *	Java 25 Factory service implementation for TimestampType JPA objects.
 */
public class CFBamJpaTimestampTypeFactoryService
    implements ICFBamTimestampTypeFactory
{
    public CFBamJpaTimestampTypeFactoryService() { }

    @Override
    public ICFBamTimestampTypeBySchemaIdxKey newBySchemaIdxKey() {
		ICFBamTimestampTypeBySchemaIdxKey key = new CFBamJpaTimestampTypeBySchemaIdxKey();
	return( key );
    }
    ...
    public ICFBamTimestampType newRec() {
        ICFBamTimestampType rec = new CFBamJpaTimestampType();
        return( rec );
    }
    ...
    public ICFBamTimestampTypeH newHRec() {
        ICFBamTimestampTypeH hrec = new CFBamJpaTimestampTypeH();
        return( hrec );
    }
