...
// Description: Java 25 Factory service implementation for TokenDef JPA objects
...
/*
 *	Java 25 Factory service implementation for TokenDef JPA objects.
 */
public class CFBamJpaTokenDefFactoryService
    implements ICFBamTokenDefFactory
{
    public CFBamJpaTokenDefFactoryService() { }

    @Override
    public ICFBamTokenDef newRec() {
        ICFBamTokenDef rec = new CFBamJpaTokenDef();
        return( rec );
    }
    ...
    public ICFBamTokenDefH newHRec() {
        ICFBamTokenDefH hrec = new CFBamJpaTokenDefH();
        return( hrec );
    }
