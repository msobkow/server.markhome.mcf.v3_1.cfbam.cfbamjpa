// Description: Java 25 JPA implementation of a Tweak by ScopeIdx index key object.
...
public class CFBamJpaTweakByScopeIdxKey
	implements ICFBamTweakByScopeIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamTweakByScopeIdxKey, ICFBamTweak$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamTweakByScopeIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
