// Description: Java 25 JPA implementation of a Tweak by UDefIdx index key object.
...
public class CFBamJpaTweakByUDefIdxKey
	implements ICFBamTweakByUDefIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamTweakByUDefIdxKey, ICFBamTweak$emitIndexKeyEqualsHistoryClass$");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamTweakByUDefIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
