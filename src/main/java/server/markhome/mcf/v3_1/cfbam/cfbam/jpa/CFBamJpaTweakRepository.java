// Description: Java 25 Spring JPA Repository for Tweak
...
/**
 *	JpaRepository for the CFBamJpaTweak entities defined in server.markhome.mcf.v3_1.cfbam.cfbam.jpa.
 *	The manufactured repositories try to provide a rich, do-it-all interface to the JPA data store, with both object and argument-based implementations of the interface defined.
 */
@Transactional(readOnly = true)
public interface CFBamJpaTweakRepository extends JpaRepository<CFBamJpaTweak, $implCommaIJavaOptAtomType$> {

	@Transactional
	@Modifying
	CFBamJpaTweak save(CFBamJpaTweak obj);
	...
	CFBamJpaTweak get(@Param("id") ICFLibKeyHash256 requiredId);
	...
	CFBamJpaTweak findByUNameIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
	 ...
	 *		@return The found entity, typically from the JPA cache, or null if no such entity exists.
	 */
	default CFBamJpaTweak findByUNameIdx(ICFBamTweakByUNameIdxKey key) {
	...
	List<CFBamJpaTweak> findByValTentIdx(@Param("tenantId") ICFLibKeyHash256 requiredTenantId);
	 ...
	 */
	default List<CFBamJpaTweak> findByValTentIdx(ICFBamTweakByValTentIdxKey key) {
	...
	List<CFBamJpaTweak> findByScopeIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId);
	 ...
	 *		@return The found entity list, which may be empty, typically populated from the JPA cache.
	 */
	default List<CFBamJpaTweak> findByScopeIdx(ICFBamTweakByScopeIdxKey key) {
	...
	List<CFBamJpaTweak> findByDefSchemaIdx(@Param("defSchemaId") ICFLibKeyHash256 optionalDefSchemaId);
	 ...
	 *		@return The found entity list, which may be empty, typically populated from the JPA cache.
	 */
	default List<CFBamJpaTweak> findByDefSchemaIdx(ICFBamTweakByDefSchemaIdxKey key) {
	...
	CFBamJpaTweak findByUDefIdx(@Param("tenantId") ICFLibKeyHash256 requiredTenantId,
	...
	@Query("select r from CFBamJpaTweak r where r.requiredId = :id")
	CFBamJpaTweak lockByIdIdx(@Param("id") ICFLibKeyHash256 requiredId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaTweak r where r.requiredContainerScopeDef.requiredId = :scopeId and r.requiredName = :name")
	CFBamJpaTweak lockByUNameIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
		@Param("name") String requiredName);
	 ...
	 *		@return The locked entity, refreshed from the data store, or null if no such entity exists.
	 */
	default CFBamJpaTweak lockByUNameIdx(ICFBamTweakByUNameIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaTweak r where r.requiredTenantId = :tenantId")
	List<CFBamJpaTweak> lockByValTentIdx(@Param("tenantId") ICFLibKeyHash256 requiredTenantId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaTweak> lockByValTentIdx(ICFBamTweakByValTentIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaTweak r where r.requiredContainerScopeDef.requiredId = :scopeId")
	List<CFBamJpaTweak> lockByScopeIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaTweak> lockByScopeIdx(ICFBamTweakByScopeIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaTweak r where r.optionalLookupDefSchema.requiredId = :defSchemaId")
	List<CFBamJpaTweak> lockByDefSchemaIdx(@Param("defSchemaId") ICFLibKeyHash256 optionalDefSchemaId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaTweak> lockByDefSchemaIdx(ICFBamTweakByDefSchemaIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaTweak r where r.requiredTenantId = :tenantId and r.requiredContainerScopeDef.requiredId = :scopeId and r.optionalDefSchemaTenantId = :defSchemaTenantId and r.optionalLookupDefSchema.requiredId = :defSchemaId and r.requiredName = :name")
	CFBamJpaTweak lockByUDefIdx(@Param("tenantId") ICFLibKeyHash256 requiredTenantId,
		@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
		@Param("defSchemaTenantId") ICFLibKeyHash256 optionalDefSchemaTenantId,
		@Param("defSchemaId") ICFLibKeyHash256 optionalDefSchemaId,
		@Param("name") String requiredName);
