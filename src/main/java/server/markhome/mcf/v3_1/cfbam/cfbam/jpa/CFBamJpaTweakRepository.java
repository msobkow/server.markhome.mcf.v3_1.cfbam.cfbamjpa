...
public interface CFBamJpaTweakRepository extends JpaRepository<CFBamJpaTweak, CFLibDbKeyHash256> {
	...
	CFBamJpaTweak get(@Param("id") CFLibDbKeyHash256 requiredId);
	...
	List<CFBamJpaTweak> findByValTentIdx(@Param("tenantId") CFLibDbKeyHash256 requiredTenantId);
	...
	List<CFBamJpaTweak> findByDefSchemaIdx(@Param("defSchemaId") CFLibDbKeyHash256 optionalDefSchemaId);
	...
	@Query("select r from CFBamJpaTweak r where r.requiredId = :id")
	CFBamJpaTweak lockByIdIdx(@Param("id") CFLibDbKeyHash256 requiredId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaTweak r where r.requiredTenantId = :tenantId")
	List<CFBamJpaTweak> lockByValTentIdx(@Param("tenantId") CFLibDbKeyHash256 requiredTenantId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaTweak r where r.optionalLookupDefSchema.requiredId = :defSchemaId")
	List<CFBamJpaTweak> lockByDefSchemaIdx(@Param("defSchemaId") CFLibDbKeyHash256 optionalDefSchemaId);
