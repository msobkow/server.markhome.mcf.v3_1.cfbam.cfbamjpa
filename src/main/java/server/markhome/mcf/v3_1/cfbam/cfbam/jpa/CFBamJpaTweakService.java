...
public class CFBamJpaTweakService {
	...
	public CFBamJpaTweak create(CFBamJpaTweak data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31TweakRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaTweak)(cfbam31TweakRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaTweak update(CFBamJpaTweak data) {
		...
		CFBamJpaTweak existing = cfbam31TweakRepository.findById((ICFLibKeyHash256)(data.getPKey()))
