...
/**
 *	JpaRepository for the CFBamJpaUInt16Col entities defined in server.markhome.mcf.v3_1.cfbam.cfbam.jpa.
 *	The manufactured repositories try to provide a rich, do-it-all interface to the JPA data store, with both object and argument-based implementations of the interface defined.
 */
@Transactional(readOnly = true)
public interface CFBamJpaUInt16ColRepository extends JpaRepository<CFBamJpaUInt16Col, $implCommaIJavaOptAtomType$> {

	@Transactional
	@Modifying
	CFBamJpaUInt16Col save(CFBamJpaUInt16Col obj);
	...
	CFBamJpaUInt16Col get(@Param("id") ICFLibKeyHash256 requiredId);
	...
	CFBamJpaUInt16Col findByUNameIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
	...
	List<CFBamJpaUInt16Col> findByScopeIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId);
	...
	List<CFBamJpaUInt16Col> findByDefSchemaIdx(@Param("defSchemaId") ICFLibKeyHash256 optionalDefSchemaId);
	...
	List<CFBamJpaUInt16Col> findByPrevIdx(@Param("prevId") ICFLibKeyHash256 optionalPrevId);
	...
	List<CFBamJpaUInt16Col> findByNextIdx(@Param("nextId") ICFLibKeyHash256 optionalNextId);
	...
	List<CFBamJpaUInt16Col> findByContPrevIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
	...
	List<CFBamJpaUInt16Col> findByContNextIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
	 ...
	 *		@return List&lt;CFBamJpaUInt16Col&gt; of the found entities, typically from the JPA cache, or an empty list if no such entities exist.
	 */
	@Query("select r from CFBamJpaUInt16Col r where r.requiredContainerTable.requiredId = :tableId")
	List<CFBamJpaUInt16Col> findByTableIdx(@Param("tableId") ICFLibKeyHash256 requiredTableId);
	...
	@Query("select r from CFBamJpaValue r where r.requiredId = :id")
	CFBamJpaUInt16Col lockByIdIdx(@Param("id") ICFLibKeyHash256 requiredId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredContainerScope.requiredId = :scopeId and r.requiredName = :name")
	CFBamJpaUInt16Col lockByUNameIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
		@Param("name") String requiredName);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredContainerScope.requiredId = :scopeId")
	List<CFBamJpaUInt16Col> lockByScopeIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.optionalLookupDefSchema.requiredId = :defSchemaId")
	List<CFBamJpaUInt16Col> lockByDefSchemaIdx(@Param("defSchemaId") ICFLibKeyHash256 optionalDefSchemaId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.optionalLookupPrev.requiredId = :prevId")
	List<CFBamJpaUInt16Col> lockByPrevIdx(@Param("prevId") ICFLibKeyHash256 optionalPrevId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.optionalLookupNext.requiredId = :nextId")
	List<CFBamJpaUInt16Col> lockByNextIdx(@Param("nextId") ICFLibKeyHash256 optionalNextId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredContainerScope.requiredId = :scopeId and r.optionalLookupPrev.requiredId = :prevId")
	List<CFBamJpaUInt16Col> lockByContPrevIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
		@Param("prevId") ICFLibKeyHash256 optionalPrevId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredContainerScope.requiredId = :scopeId and r.optionalLookupNext.requiredId = :nextId")
	List<CFBamJpaUInt16Col> lockByContNextIdx(@Param("scopeId") ICFLibKeyHash256 requiredScopeId,
		@Param("nextId") ICFLibKeyHash256 optionalNextId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaUInt16Col r where r.requiredContainerTable.requiredId = :tableId")
	List<CFBamJpaUInt16Col> lockByTableIdx(@Param("tableId") ICFLibKeyHash256 requiredTableId);
	...
	@Transactional
	@Modifying
	@Query("delete from CFBamJpaUInt16Col r where r.requiredContainerTable.requiredId = :tableId")
