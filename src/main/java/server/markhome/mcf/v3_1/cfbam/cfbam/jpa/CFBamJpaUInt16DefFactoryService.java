...
// Description: Java 25 Factory service implementation for UInt16Def JPA objects
...
/*
 *	Java 25 Factory service implementation for UInt16Def JPA objects.
 */
public class CFBamJpaUInt16DefFactoryService
    implements ICFBamUInt16DefFactory
{
    public CFBamJpaUInt16DefFactoryService() { }

    @Override
    public ICFBamUInt16Def newRec() {
        ICFBamUInt16Def rec = new CFBamJpaUInt16Def();
        return( rec );
    }
    ...
    public ICFBamUInt16DefH newHRec() {
        ICFBamUInt16DefH hrec = new CFBamJpaUInt16DefH();
        return( hrec );
    }
