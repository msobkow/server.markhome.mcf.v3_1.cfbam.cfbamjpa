...
public class CFBamJpaUInt16TypeTable implements ICFBamUInt16TypeTable
{
		...
		ICFBamUInt16Type rec )
	{
		...
		if (!permissionGranted) {
			throw new CFLibPermissionDeniedException(getClass(), S_ProcName, "createuint16type", ICFBamSchema.SCHEMA_NAME, ICFBamUInt16TypeTable.TABLE_NAME, Authorization.getAuthUuid6().toString());//"Permission '%4$s' denied attempting to access %1$s.%2$s for user id %3$s"
		}
		...
		ICFBamUInt16Type rec )
	{
		...
		if (!permissionGranted) {
			throw new CFLibPermissionDeniedException(getClass(), S_ProcName, "updateuint16type", ICFBamSchema.SCHEMA_NAME, ICFBamUInt16TypeTable.TABLE_NAME, Authorization.getAuthUuid6().toString());//"Permission '%4$s' denied attempting to access %1$s.%2$s for user id %3$s"
		}
		...
		ICFBamUInt16Type rec )
	{
		...
		if (!permissionGranted) {
			throw new CFLibPermissionDeniedException(getClass(), S_ProcName, "deleteuint16type", ICFBamSchema.SCHEMA_NAME, ICFBamUInt16TypeTable.TABLE_NAME, Authorization.getAuthUuid6().toString());//"Permission '%4$s' denied attempting to access %1$s.%2$s for user id %3$s"
		}
		...
		CFLibDbKeyHash256 PKey )
	{
		...
		if (!permissionGranted) {
			throw new CFLibPermissionDeniedException(getClass(), S_ProcName, "readuint16type", ICFBamSchema.SCHEMA_NAME, ICFBamUInt16TypeTable.TABLE_NAME, Authorization.getAuthUuid6().toString());//"Permission '%4$s' denied attempting to access %1$s.%2$s for user id %3$s"
		}
