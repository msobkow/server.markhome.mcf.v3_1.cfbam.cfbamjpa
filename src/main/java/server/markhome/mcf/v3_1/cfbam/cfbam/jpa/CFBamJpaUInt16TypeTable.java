...
public class CFBamJpaUInt16TypeTable implements ICFBamUInt16TypeTable
{
		...
		ICFBamUInt16Type rec )
	{
		...
		if(!permissionGranted) {
			permissionGranted = ICFSecSchema.getBackingCFSec().isMemberOfTenantGroup(Authorization.getSecUserId(), Authorization.getSecTenantId(), "createuint16type");
		}
		if(!permissionGranted) {
			permissionGranted = ICFSecSchema.getBackingCFSec().isMemberOfClusterGroup(Authorization.getSecUserId(), Authorization.getSecClusterId(), "createuint16type");
		}
		if(!permissionGranted) {
			permissionGranted = ICFSecSchema.getBackingCFSec().isMemberOfSystemGroup(Authorization.getSecUserId(), "createuint16type");
		}
		if (!permissionGranted) {
			throw new CFLibPermissionDeniedException(getClass(), S_ProcName, ICFBamSchema.SCHEMA_NAME, ICFBamUInt16TypeTable.TABLE_NAME, "createuint16type", authUserId.toString());//"Permission '%4$s' denied attempting to access %1$s.%2$s for user id %3$s"
		}
		...
		if (rec == null) {
			...
			CFBamJpaUInt16Type retval = schema.getJpaHooksSchema().getUInt16TypeService().create(jparec);
		if(retval != null) {
			// Retrieve the TenantId from retval and check ICFSec.backingSchema().isMemberOfTenantGroup(auth,TenantId,'readuint16type'), clear retval to null if not a member
			CFLibDbKeyHash256 effTenantId = CFLibDbKeyHash256.nullGet();
			if (!ICFSecSchema.getBackingCFSec().isMemberOfTenantGroup(Authorization.getSecUserId(), effTenantId, "readuint16type")) {
				retval = null;
			}
		}
		return( retval );
		...
		ICFBamUInt16Type rec )
	{
		...
		if(!permissionGranted) {
			permissionGranted = ICFSecSchema.getBackingCFSec().isMemberOfTenantGroup(Authorization.getSecUserId(), ICFSecSchema.getSysTenantId(), "updateuint16type");
		}
		if(!permissionGranted) {
			permissionGranted = ICFSecSchema.getBackingCFSec().isMemberOfClusterGroup(Authorization.getSecUserId(), ICFSecSchema.getSysClusterId(), "updateuint16type");
		}
		if(!permissionGranted) {
			permissionGranted = ICFSecSchema.getBackingCFSec().isMemberOfSystemGroup(Authorization.getSecUserId(), "updateuint16type");
		}
		if (!permissionGranted) {
			throw new CFLibPermissionDeniedException(getClass(), S_ProcName, ICFBamSchema.SCHEMA_NAME, ICFBamUInt16TypeTable.TABLE_NAME, "updateuint16type", authUserId.toString());//"Permission '%4$s' denied attempting to access %1$s.%2$s for user id %3$s"
		}
		...
		if (rec == null) {
			...
			CFBamJpaUInt16Type jparec = (CFBamJpaUInt16Type)rec;
			CFBamJpaUInt16Type retval = schema.getJpaHooksSchema().getUInt16TypeService().update(jparec);
		if(retval != null) {
			// Retrieve the TenantId from retval and check ICFSec.backingSchema().isMemberOfTenantGroup(auth,TenantId,'readuint16type'), clear retval to null if not a member
			CFLibDbKeyHash256 effTenantId = CFLibDbKeyHash256.nullGet();
			if (!ICFSecSchema.getBackingCFSec().isMemberOfTenantGroup(Authorization.getSecUserId(), effTenantId, "readuint16type")) {
		...
		ICFBamUInt16Type rec )
	{
		...
		if(!permissionGranted) {
			permissionGranted = ICFSecSchema.getBackingCFSec().isMemberOfTenantGroup(Authorization.getSecUserId(), ICFSecSchema.getSysTenantId(), "deleteuint16type");
		}
		if(!permissionGranted) {
			permissionGranted = ICFSecSchema.getBackingCFSec().isMemberOfClusterGroup(Authorization.getSecUserId(), ICFSecSchema.getSysClusterId(), "deleteuint16type");
		}
		if(!permissionGranted) {
			permissionGranted = ICFSecSchema.getBackingCFSec().isMemberOfSystemGroup(Authorization.getSecUserId(), "deleteuint16type");
		}
		if (!permissionGranted) {
			throw new CFLibPermissionDeniedException(getClass(), S_ProcName, ICFBamSchema.SCHEMA_NAME, ICFBamUInt16TypeTable.TABLE_NAME, "deleteuint16type", authUserId.toString());//"Permission '%4$s' denied attempting to access %1$s.%2$s for user id %3$s"
		}
		...
		CFLibDbKeyHash256 PKey )
	{
		...
		if(!permissionGranted) {
			permissionGranted = ICFSecSchema.getBackingCFSec().isMemberOfTenantGroup(Authorization.getSecUserId(), Authorization.getSecTenantId(), "readuint16type");
		}
		if(!permissionGranted) {
			permissionGranted = ICFSecSchema.getBackingCFSec().isMemberOfClusterGroup(Authorization.getSecUserId(), Authorization.getSecClusterId(), "readuint16type");
		}
		if(!permissionGranted) {
			permissionGranted = ICFSecSchema.getBackingCFSec().isMemberOfSystemGroup(Authorization.getSecUserId(), "readuint16type");
		}
		if (!permissionGranted) {
			throw new CFLibPermissionDeniedException(getClass(), S_ProcName, ICFBamSchema.SCHEMA_NAME, ICFBamUInt16TypeTable.TABLE_NAME, "readuint16type", authUserId.toString());//"Permission '%4$s' denied attempting to access %1$s.%2$s for user id %3$s"
		}

		ICFBamUInt16Type retval = schema.getJpaHooksSchema().getUInt16TypeService().find(PKey);
		if(retval != null) {
			// Retrieve the TenantId from retval and check ICFSec.backingSchema().isMemberOfTenantGroup(auth,TenantId,'readuint16type'), clear retval to null if not a member
			CFLibDbKeyHash256 effTenantId = CFLibDbKeyHash256.nullGet();
			if (!ICFSecSchema.getBackingCFSec().isMemberOfTenantGroup(Authorization.getSecUserId(), effTenantId, "readuint16type")) {
		...
		CFLibDbKeyHash256 PKey )
	{
		...
		ICFBamUInt16Type retval = schema.getJpaHooksSchema().getUInt16TypeService().lockByIdIdx(PKey);
		if(retval != null) {
			// Retrieve the TenantId from retval and check ICFSec.backingSchema().isMemberOfTenantGroup(auth,TenantId,'readuint16type'), clear retval to null if not a member
			CFLibDbKeyHash256 effTenantId = CFLibDbKeyHash256.nullGet();
			if (!ICFSecSchema.getBackingCFSec().isMemberOfTenantGroup(Authorization.getSecUserId(), effTenantId, "readuint16type")) {
	...
	public ICFBamUInt16Type[] readAllDerived( ICFSecAuthorization Authorization ) {
		...
		List<CFBamJpaUInt16Type> retlist = schema.getJpaHooksSchema().getUInt16TypeService().findAll();
		if(retlist != null) {
			ArrayList<CFBamJpaUInt16Type> finallist = new ArrayList<>();
		...
		ICFBamUInt16Type[] retset = new ICFBamUInt16Type[retlist.size()];
		int idx = 0;
		for (CFBamJpaUInt16Type cur: retlist) {
			retset[idx++] = cur;
		}
		return( retset );
	}
		...
		CFLibDbKeyHash256 argId )
	{
		...
		ICFBamUInt16Type retval = schema.getJpaHooksSchema().getUInt16TypeService().find(argId);
		if(retval != null) {
			// Retrieve the TenantId from retval and check ICFSec.backingSchema().isMemberOfTenantGroup(auth,TenantId,'readuint16type'), clear retval to null if not a member
			CFLibDbKeyHash256 effTenantId = CFLibDbKeyHash256.nullGet();
			if (!ICFSecSchema.getBackingCFSec().isMemberOfTenantGroup(Authorization.getSecUserId(), effTenantId, "readuint16type")) {
		...
		String argName )
	{
		...
		ICFBamUInt16Type retval = schema.getJpaHooksSchema().getUInt16TypeService().findByUNameIdx(argScopeId,
		argName);
		if(retval != null) {
			// Retrieve the TenantId from retval and check ICFSec.backingSchema().isMemberOfTenantGroup(auth,TenantId,'readuint16type'), clear retval to null if not a member
			CFLibDbKeyHash256 effTenantId = CFLibDbKeyHash256.nullGet();
		...
		CFLibDbKeyHash256 argScopeId )
	{
		...
		List<CFBamJpaUInt16Type> retlist = schema.getJpaHooksSchema().getUInt16TypeService().findByScopeIdx(argScopeId);
		if(retlist != null) {
			ArrayList<CFBamJpaUInt16Type> finallist = new ArrayList<>();
			for (var retval: retlist) {
				if(retval != null) {
		...
		CFLibDbKeyHash256 argDefSchemaId )
	{
		...
		List<CFBamJpaUInt16Type> retlist = schema.getJpaHooksSchema().getUInt16TypeService().findByDefSchemaIdx(argDefSchemaId);
		if(retlist != null) {
			ArrayList<CFBamJpaUInt16Type> finallist = new ArrayList<>();
			for (var retval: retlist) {
				if(retval != null) {
		...
		CFLibDbKeyHash256 argPrevId )
	{
		...
		List<CFBamJpaUInt16Type> retlist = schema.getJpaHooksSchema().getUInt16TypeService().findByPrevIdx(argPrevId);
		if(retlist != null) {
			ArrayList<CFBamJpaUInt16Type> finallist = new ArrayList<>();
			for (var retval: retlist) {
				if(retval != null) {
		...
		CFLibDbKeyHash256 argNextId )
	{
		...
		List<CFBamJpaUInt16Type> retlist = schema.getJpaHooksSchema().getUInt16TypeService().findByNextIdx(argNextId);
		if(retlist != null) {
			ArrayList<CFBamJpaUInt16Type> finallist = new ArrayList<>();
			for (var retval: retlist) {
				if(retval != null) {
		...
		CFLibDbKeyHash256 argPrevId )
	{
		...
		List<CFBamJpaUInt16Type> retlist = schema.getJpaHooksSchema().getUInt16TypeService().findByContPrevIdx(argScopeId,
		argPrevId);
		if(retlist != null) {
			ArrayList<CFBamJpaUInt16Type> finallist = new ArrayList<>();
			for (var retval: retlist) {
		...
		CFLibDbKeyHash256 argNextId )
	{
		...
		List<CFBamJpaUInt16Type> retlist = schema.getJpaHooksSchema().getUInt16TypeService().findByContNextIdx(argScopeId,
		argNextId);
		if(retlist != null) {
			ArrayList<CFBamJpaUInt16Type> finallist = new ArrayList<>();
			for (var retval: retlist) {
		...
		CFLibDbKeyHash256 argSchemaDefId )
	{
		...
		List<CFBamJpaUInt16Type> retlist = schema.getJpaHooksSchema().getUInt16TypeService().findBySchemaIdx(argSchemaDefId);
		if(retlist != null) {
			ArrayList<CFBamJpaUInt16Type> finallist = new ArrayList<>();
			for (var retval: retlist) {
				if(retval != null) {
