...
// Description: Java 25 Factory service implementation for UInt32Col JPA objects
...
/*
 *	Java 25 Factory service implementation for UInt32Col JPA objects.
 */
public class CFBamJpaUInt32ColFactoryService
    implements ICFBamUInt32ColFactory
{
    public CFBamJpaUInt32ColFactoryService() { }

    @Override
    public ICFBamUInt32ColByTableIdxKey newByTableIdxKey() {
		ICFBamUInt32ColByTableIdxKey key = new CFBamJpaUInt32ColByTableIdxKey();
	return( key );
    }
    ...
    public ICFBamUInt32Col newRec() {
        ICFBamUInt32Col rec = new CFBamJpaUInt32Col();
        return( rec );
    }
    ...
    public ICFBamUInt32ColH newHRec() {
        ICFBamUInt32ColH hrec = new CFBamJpaUInt32ColH();
        return( hrec );
    }
