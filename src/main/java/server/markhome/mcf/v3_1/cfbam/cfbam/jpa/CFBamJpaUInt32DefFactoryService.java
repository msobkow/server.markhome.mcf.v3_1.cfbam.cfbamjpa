...
// Description: Java 25 Factory service implementation for UInt32Def JPA objects
...
/*
 *	Java 25 Factory service implementation for UInt32Def JPA objects.
 */
public class CFBamJpaUInt32DefFactoryService
    implements ICFBamUInt32DefFactory
{
    public CFBamJpaUInt32DefFactoryService() { }

    @Override
    public ICFBamUInt32Def newRec() {
        ICFBamUInt32Def rec = new CFBamJpaUInt32Def();
        return( rec );
    }
    ...
    public ICFBamUInt32DefH newHRec() {
        ICFBamUInt32DefH hrec = new CFBamJpaUInt32DefH();
        return( hrec );
    }
