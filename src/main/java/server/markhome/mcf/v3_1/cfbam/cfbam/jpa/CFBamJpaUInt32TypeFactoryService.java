...
// Description: Java 25 Factory service implementation for UInt32Type JPA objects
...
/*
 *	Java 25 Factory service implementation for UInt32Type JPA objects.
 */
public class CFBamJpaUInt32TypeFactoryService
    implements ICFBamUInt32TypeFactory
{
    public CFBamJpaUInt32TypeFactoryService() { }

    @Override
    public ICFBamUInt32TypeBySchemaIdxKey newBySchemaIdxKey() {
		ICFBamUInt32TypeBySchemaIdxKey key = new CFBamJpaUInt32TypeBySchemaIdxKey();
	return( key );
    }
    ...
    public ICFBamUInt32Type newRec() {
        ICFBamUInt32Type rec = new CFBamJpaUInt32Type();
        return( rec );
    }
    ...
    public ICFBamUInt32TypeH newHRec() {
        ICFBamUInt32TypeH hrec = new CFBamJpaUInt32TypeH();
        return( hrec );
    }
