...
// Description: Java 25 Factory service implementation for UInt64Col JPA objects
...
/*
 *	Java 25 Factory service implementation for UInt64Col JPA objects.
 */
public class CFBamJpaUInt64ColFactoryService
    implements ICFBamUInt64ColFactory
{
    public CFBamJpaUInt64ColFactoryService() { }

    @Override
    public ICFBamUInt64ColByTableIdxKey newByTableIdxKey() {
		ICFBamUInt64ColByTableIdxKey key = new CFBamJpaUInt64ColByTableIdxKey();
	return( key );
    }
    ...
    public ICFBamUInt64Col newRec() {
        ICFBamUInt64Col rec = new CFBamJpaUInt64Col();
        return( rec );
    }
    ...
    public ICFBamUInt64ColH newHRec() {
        ICFBamUInt64ColH hrec = new CFBamJpaUInt64ColH();
        return( hrec );
    }
