...
// Description: Java 25 Factory service implementation for UInt64Def JPA objects
...
/*
 *	Java 25 Factory service implementation for UInt64Def JPA objects.
 */
public class CFBamJpaUInt64DefFactoryService
    implements ICFBamUInt64DefFactory
{
    ...
    public ICFBamUInt64DefH newHRec() {
        ICFBamUInt64DefH hrec = new CFBamJpaUInt64DefH();
        return( hrec );
    }
