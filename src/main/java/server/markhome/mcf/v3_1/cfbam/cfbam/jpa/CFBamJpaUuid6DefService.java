...
public class CFBamJpaUuid6DefService {
	...
	public CFBamJpaUuid6Def create(CFBamJpaUuid6Def data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31Uuid6DefRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaUuid6Def)(cfbam31Uuid6DefRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaUuid6Def update(CFBamJpaUuid6Def data) {
		...
		CFBamJpaUuid6Def existing = cfbam31Uuid6DefRepository.findById((ICFLibKeyHash256)(data.getPKey()))
