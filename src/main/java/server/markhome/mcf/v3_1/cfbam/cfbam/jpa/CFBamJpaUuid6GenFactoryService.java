...
// Description: Java 25 Factory service implementation for Uuid6Gen JPA objects
...
/*
 *	Java 25 Factory service implementation for Uuid6Gen JPA objects.
 */
public class CFBamJpaUuid6GenFactoryService
    implements ICFBamUuid6GenFactory
{
    public CFBamJpaUuid6GenFactoryService() { }

    @Override
    public ICFBamUuid6Gen newRec() {
        ICFBamUuid6Gen rec = new CFBamJpaUuid6Gen();
        return( rec );
    }
    ...
    public ICFBamUuid6GenH newHRec() {
        ICFBamUuid6GenH hrec = new CFBamJpaUuid6GenH();
        return( hrec );
    }
