...
public class CFBamJpaUuidGenService {
	...
	public CFBamJpaUuidGen create(CFBamJpaUuidGen data) {
		...
		try {
			if(data.getPKey() != null && !data.getPKey().isNull() && cfbam31UuidGenRepository.existsById((ICFLibKeyHash256)data.getPKey())) {
				return( (CFBamJpaUuidGen)(cfbam31UuidGenRepository.findById((ICFLibKeyHash256)(data.getPKey())).get()));
			}
	...
	public CFBamJpaUuidGen update(CFBamJpaUuidGen data) {
		...
		CFBamJpaUuidGen existing = cfbam31UuidGenRepository.findById((ICFLibKeyHash256)(data.getPKey()))
